...
- Name: screenshot.docs.spec.ts >> Docs screenshots >> pathname /paletteai-inference-launchpad/tags/claude-code/
- Location: visuals/screenshot.docs.spec.ts:38:7

# Error details

```
Error: A snapshot doesn't exist at /home/runner/work/librarium/librarium/screenshots/screenshot.docs.spec.ts-snapshots/Docs-screenshots-pathname-paletteai-inference-launchpad-tags-claude-code-1-chromium-linux.png, writing actual.
```
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e36]:
      - generic [ref=e37]:
        - heading "2 docs tagged with \"claude-code\"" [level=1] [ref=e38]
        - link "View all tags" [ref=e39] [cursor=pointer]:
          - /url: /paletteai-inference-launchpad/tags/
      - generic [ref=e40]:
        - article [ref=e41]:
          - link "PaletteAI Inference Launchpad Claude Code Configuration" [ref=e42] [cursor=pointer]:
            - /url: /paletteai-inference-launchpad/reference/claude-code-reference/
            - heading "PaletteAI Inference Launchpad Claude Code Configuration" [level=2] [ref=e43]
          - paragraph [ref=e44]: Reference for the environment variables and values used to connect Claude Code to a PaletteAI Inference Launchpad appliance.
        - article [ref=e45]:
          - link "Use PaletteAI Inference Launchpad with Claude Code" [ref=e46] [cursor=pointer]:
            - /url: /paletteai-inference-launchpad/how-to-guides/use-claude-code/
            - heading "Use PaletteAI Inference Launchpad with Claude Code" [level=2] [ref=e47]
          - paragraph [ref=e48]: Connect Anthropic's Claude Code coding agent to a PaletteAI Inference Launchpad appliance so that a model on the appliance serves every request.
