                ...
                - list [ref=e99]:
                  ...
                  - listitem [ref=e104]:
                    - link "How-to Guides" [ref=e105] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/
                  - listitem [ref=e106]:
                    - generic [ref=e107]: Generate an API Token
              - generic [ref=e108]:
                - heading "Generate an API Token" [level=1] [ref=e110]
                - paragraph [ref=e111]:
                  ...
                  - link "Create a Client" [ref=e113] [cursor=pointer]:
                    - /url: /paletteai-inference-launchpad/how-to-guides/create-a-client/
                  - text: .
                - heading "PrerequisitesDirect link to Prerequisites" [level=2] [ref=e114]:
                  ...
                  - link "Direct link to Prerequisites" [ref=e115] [cursor=pointer]:
                    ...
                    - text: "#"
                - list [ref=e116]:
                  - listitem [ref=e117]: A running PaletteAI Inference Launchpad appliance, with the console reachable.
                  - listitem [ref=e118]:
                    - text: An existing client to issue the token to. To create one, refer to
                    - link "Create a Client" [ref=e119] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/create-a-client/
                    - text: .
                  - listitem [ref=e120]: Console access with permission to create API tokens. Creating a token can require operator access.
                - heading "Generate an API TokenDirect link to Generate an API Token" [level=2] [ref=e121]:
                  - text: Generate an API Token
                  - link "Direct link to Generate an API Token" [ref=e122] [cursor=pointer]:
                    - /url: "#generate-an-api-token"
                    - text: "#"
                - paragraph [ref=e123]: If an administrator already gave you an API token, you can use it and skip the following steps.
                - list [ref=e124]:
                  - listitem [ref=e125]:
                    - paragraph [ref=e126]:
                  ...
                  - listitem [ref=e133]:
                    - paragraph [ref=e134]:
                      ...
                      - strong [ref=e136]: Create Token
                      - text: . The
                      - strong [ref=e137]: Create API token
                      - text: dialog opens.
                  - listitem [ref=e138]:
                    - paragraph [ref=e139]:
                      - emphasis [ref=e140]: (Optional)
                      - text: In the
                      - strong [ref=e141]: Label
                ...
                - generic [ref=e154]:
                  - generic [ref=e155]:
                    - img [ref=e157]
                    - text: warning
                  - paragraph [ref=e160]: The console shows the token only once and stores only a hash of it. Copy it now. If you lose it, revoke the token and create a new one.
                - heading "Next StepsDirect link to Next Steps" [level=2] [ref=e161]:
                  - text: Next Steps
                  - link "Direct link to Next Steps" [ref=e162] [cursor=pointer]:
                    - /url: "#next-steps"
                    - text: "#"
                - paragraph [ref=e163]: Use the token to connect a coding assistant to the appliance.
                - list [ref=e164]:
                  - listitem [ref=e165]:
                  ...
                  - listitem [ref=e169]:
                    - link "Use OpenAI Codex" [ref=e170] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/use-codex/
                  - listitem [ref=e171]:
                    - link "Use OpenCode" [ref=e172] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/use-opencode/
              - generic [ref=e173]:
                - generic [ref=e175]:
                  - text: "Tags:"
                  - list [ref=e176]:
                    - listitem [ref=e177]:
                      - link "paletteai-inference-launchpad" [ref=e178] [cursor=pointer]:
                        - /url: /paletteai-inference-launchpad/tags/paletteai-inference-launchpad/
                    - listitem [ref=e179]:
                      - link "api-token" [ref=e180] [cursor=pointer]:
                        - /url: /paletteai-inference-launchpad/tags/api-token/
                    - listitem [ref=e181]:
                      - link "how-to" [ref=e182] [cursor=pointer]:
                        - /url: /paletteai-inference-launchpad/tags/how-to/
                - link "Edit this page" [ref=e185] [cursor=pointer]:
                  ...
                  - img [ref=e186]
                  - text: Edit this page
            - navigation "Docs pages" [ref=e190]:
              - link "Previous « Create a Client" [ref=e191] [cursor=pointer]:
                - /url: /paletteai-inference-launchpad/how-to-guides/create-a-client/
                - generic [ref=e192]: Previous
                - generic [ref=e193]: « Create a Client
              - link "Next Set and Manage Client Quotas »" [ref=e194] [cursor=pointer]:
                - /url: /paletteai-inference-launchpad/how-to-guides/manage-client-quotas/
                - generic [ref=e195]: Next
                - generic [ref=e196]: Set and Manage Client Quotas »
          - list [ref=e199]:
            - listitem [ref=e200]:
              - link "Prerequisites" [ref=e201] [cursor=pointer]:
                - /url: "#prerequisites"
            - listitem [ref=e202]:
              - link "Generate an API Token" [ref=e203] [cursor=pointer]:
                - /url: "#generate-an-api-token"
            - listitem [ref=e204]:
              - link "Next Steps" [ref=e205] [cursor=pointer]:
                - /url: "#next-steps"
  - button "Project Logo Ask AI" [ref=e206] [cursor=pointer]:
    - generic [ref=e209]:
      - img "Project Logo" [ref=e210]
      - paragraph [ref=e211]: Ask AI
```
