...
- Name: screenshot.docs.spec.ts >> Docs screenshots >> pathname /paletteai-inference-launchpad/tags/clients/
- Location: visuals/screenshot.docs.spec.ts:38:7

# Error details

```
Error: A snapshot doesn't exist at /home/runner/work/librarium/librarium/screenshots/screenshot.docs.spec.ts-snapshots/Docs-screenshots-pathname-paletteai-inference-launchpad-tags-clients-1-chromium-linux.png, writing actual.
```
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e36]:
      - generic [ref=e37]:
        - heading "6 docs tagged with \"clients\"" [level=1] [ref=e38]
      ...
      - generic [ref=e40]:
        ...
        - article [ref=e45]:
          - link "Create a Client" [ref=e46] [cursor=pointer]:
            - /url: /paletteai-inference-launchpad/how-to-guides/create-a-client/
            - heading "Create a Client" [level=2] [ref=e47]
          - paragraph [ref=e48]: Step-by-step guidance for platform administrators on how to create a client on a PaletteAI Inference Launchpad appliance by stepping through the Add client wizard and issuing the client's first API token.
        - article [ref=e49]:
        ...
        - article [ref=e53]:
          - link "Revoke or Delete a Client" [ref=e54] [cursor=pointer]:
            - /url: /paletteai-inference-launchpad/how-to-guides/revoke-or-delete-a-client/
            - heading "Revoke or Delete a Client" [level=2] [ref=e55]
          - paragraph [ref=e56]: Step-by-step guidance for platform administrators on how to find expired keys, revoke an API token, and delete a client on a PaletteAI Inference Launchpad appliance, and what happens to in-flight requests.
        - article [ref=e57]:
          - link "Set and Manage Client Quotas" [ref=e58] [cursor=pointer]:
            - /url: /paletteai-inference-launchpad/how-to-guides/manage-client-quotas/
            - heading "Set and Manage Client Quotas" [level=2] [ref=e59]
          - paragraph [ref=e60]: Step-by-step guidance for platform administrators on how to set, edit, and remove usage quotas on a client on a PaletteAI Inference Launchpad appliance.
        - article [ref=e61]:
          - link "View Client Usage" [ref=e62] [cursor=pointer]:
            - /url: /paletteai-inference-launchpad/how-to-guides/view-client-usage/
            - heading "View Client Usage" [level=2] [ref=e63]
          - paragraph [ref=e64]: Step-by-step guidance for platform administrators on how to view per-client and per-token consumption on a PaletteAI Inference Launchpad appliance.
  - button "Project Logo Ask AI" [ref=e65] [cursor=pointer]:
    - generic [ref=e68]:
      - img "Project Logo" [ref=e69]
      - paragraph [ref=e70]: Ask AI
```
