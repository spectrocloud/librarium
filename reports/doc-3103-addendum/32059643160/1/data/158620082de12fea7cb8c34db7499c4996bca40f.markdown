...
- Name: screenshot.docs.spec.ts >> Docs screenshots >> pathname /paletteai-inference-launchpad/tags/profile/
- Location: visuals/screenshot.docs.spec.ts:38:7

# Error details

```
Error: A snapshot doesn't exist at /home/runner/work/librarium/librarium/screenshots/screenshot.docs.spec.ts-snapshots/Docs-screenshots-pathname-paletteai-inference-launchpad-tags-profile-1-chromium-linux.png, writing actual.
```
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e36]:
      - generic [ref=e37]:
        - heading "One doc tagged with \"profile\"" [level=1] [ref=e38]
        - link "View all tags" [ref=e39] [cursor=pointer]:
          - /url: /paletteai-inference-launchpad/tags/
      - article [ref=e41]:
        - link "Cluster Profile Variables" [ref=e42] [cursor=pointer]:
          - /url: /paletteai-inference-launchpad/reference/profile-variables/
          - heading "Cluster Profile Variables" [level=2] [ref=e43]
        - paragraph [ref=e44]: Reference for the PaletteAI Inference Launchpad cluster profile variables collected by the Profile Config wizard. Covers networking, OS and metrics, container registry, local admin, storage, and certificates with types, required fields, defaults, and validation rules.
  - button "Project Logo Ask AI" [ref=e45] [cursor=pointer]:
    - generic [ref=e48]:
      - img "Project Logo" [ref=e49]
      - paragraph [ref=e50]: Ask AI
```
