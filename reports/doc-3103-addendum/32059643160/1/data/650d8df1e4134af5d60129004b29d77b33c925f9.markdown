...
- Name: screenshot.docs.spec.ts >> Docs screenshots >> pathname /paletteai-inference-launchpad/tags/release-notes/
- Location: visuals/screenshot.docs.spec.ts:38:7

# Error details

```
Error: A snapshot doesn't exist at /home/runner/work/librarium/librarium/screenshots/screenshot.docs.spec.ts-snapshots/Docs-screenshots-pathname-paletteai-inference-launchpad-tags-release-notes-1-chromium-linux.png, writing actual.
```
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e36]:
      - generic [ref=e37]:
        - heading "One doc tagged with \"release-notes\"" [level=1] [ref=e38]
        - link "View all tags" [ref=e39] [cursor=pointer]:
          - /url: /paletteai-inference-launchpad/tags/
      - article [ref=e41]:
        - link "PaletteAI Inference Launchpad Release Notes" [ref=e42] [cursor=pointer]:
          - /url: /paletteai-inference-launchpad/release-notes/
          - heading "PaletteAI Inference Launchpad Release Notes" [level=2] [ref=e43]
        - paragraph [ref=e44]: Release notes for PaletteAI Inference Launchpad, including new features, improvements, and bug fixes.
