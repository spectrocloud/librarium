...
```
Error: A snapshot doesn't exist at /home/runner/work/librarium/librarium/screenshots/screenshot.docs.spec.ts-snapshots/Docs-screenshots-pathname-paletteai-inference-launchpad-tags-usage-1-chromium-linux.png, writing actual.
```
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e36]:
      - generic [ref=e37]:
        - heading "One doc tagged with \"usage\"" [level=1] [ref=e38]
        - link "View all tags" [ref=e39] [cursor=pointer]:
          - /url: /paletteai-inference-launchpad/tags/
      - article [ref=e41]:
        - link "View Client Usage" [ref=e42] [cursor=pointer]:
          - /url: /paletteai-inference-launchpad/how-to-guides/view-client-usage/
          - heading "View Client Usage" [level=2] [ref=e43]
        - paragraph [ref=e44]: Step-by-step guidance for platform administrators on how to view per-client and per-token consumption on a PaletteAI Inference Launchpad appliance.
