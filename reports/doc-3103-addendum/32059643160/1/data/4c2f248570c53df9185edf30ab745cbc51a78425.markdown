...
- Name: screenshot.docs.spec.ts >> Docs screenshots >> pathname /paletteai-inference-launchpad/tags/tutorial/
- Location: visuals/screenshot.docs.spec.ts:38:7

# Error details

```
Error: A snapshot doesn't exist at /home/runner/work/librarium/librarium/screenshots/screenshot.docs.spec.ts-snapshots/Docs-screenshots-pathname-paletteai-inference-launchpad-tags-tutorial-1-chromium-linux.png, writing actual.
```
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e36]:
      - generic [ref=e37]:
        - heading "One doc tagged with \"tutorial\"" [level=1] [ref=e38]
        - link "View all tags" [ref=e39] [cursor=pointer]:
          - /url: /paletteai-inference-launchpad/tags/
      - article [ref=e41]:
        - link "Tutorials" [ref=e42] [cursor=pointer]:
          - /url: /paletteai-inference-launchpad/tutorials/
          - heading "Tutorials" [level=2] [ref=e43]
        - paragraph [ref=e44]: Hands-on, end-to-end tutorials for deploying and running PaletteAI Inference Launchpad.
