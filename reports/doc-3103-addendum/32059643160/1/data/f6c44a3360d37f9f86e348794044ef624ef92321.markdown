...
- Name: screenshot.docs.spec.ts >> Docs screenshots >> pathname /paletteai-inference-launchpad/tags/api-token/
- Location: visuals/screenshot.docs.spec.ts:38:7

# Error details

```
Error: A snapshot doesn't exist at /home/runner/work/librarium/librarium/screenshots/screenshot.docs.spec.ts-snapshots/Docs-screenshots-pathname-paletteai-inference-launchpad-tags-api-token-1-chromium-linux.png, writing actual.
```
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e36]:
      - generic [ref=e37]:
        - heading "2 docs tagged with \"api-token\"" [level=1] [ref=e38]
        - link "View all tags" [ref=e39] [cursor=pointer]:
          - /url: /paletteai-inference-launchpad/tags/
      - generic [ref=e40]:
        - article [ref=e41]:
          - link "Generate an API Token" [ref=e42] [cursor=pointer]:
            - /url: /paletteai-inference-launchpad/how-to-guides/generate-an-api-token/
            - heading "Generate an API Token" [level=2] [ref=e43]
          - paragraph [ref=e44]: Step-by-step guidance on how to generate an API token in the PaletteAI Inference Launchpad console so that coding assistants and other clients can authenticate to the appliance.
        - article [ref=e45]:
          - link "Revoke or Delete a Client" [ref=e46] [cursor=pointer]:
            - /url: /paletteai-inference-launchpad/how-to-guides/revoke-or-delete-a-client/
            - heading "Revoke or Delete a Client" [level=2] [ref=e47]
          - paragraph [ref=e48]: Step-by-step guidance for platform administrators on how to find expired keys, revoke an API token, and delete a client on a PaletteAI Inference Launchpad appliance, and what happens to in-flight requests.
