        ...
        - generic [ref=e76]:
          - generic [ref=e78]:
                ...
                - list [ref=e81]:
                  ...
                  - listitem [ref=e86]:
                    - link "Explanation" [ref=e87] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/explanation/
                  - listitem [ref=e88]:
                    - generic [ref=e89]: Inference Engines
              - generic [ref=e90]:
                - heading "PaletteAI Inference Launchpad Inference Engines" [level=1] [ref=e92]
                - paragraph [ref=e93]:
                  ...
                  - link "deploy a model" [ref=e94] [cursor=pointer]:
                    - /url: /paletteai-inference-launchpad/how-to-guides/deploy-a-model/
                  - text: ", where the engine is an optional setting."
                - heading "Inference Engine OverviewDirect link to Inference Engine Overview" [level=2] [ref=e95]:
                  - text: Inference Engine Overview
                  - link "Direct link to Inference Engine Overview" [ref=e96] [cursor=pointer]:
                    - /url: "#inference-engine-overview"
                    - text: "#"
                - paragraph [ref=e97]: An inference engine is the runtime that loads a model and serves its requests. The appliance exposes each loaded model as an OpenAI-compatible endpoint, but the engine behind that endpoint is what actually runs the model on a node's CPU or GPUs. The engine determines how the model runs, which hardware it can use, and which serving features are available.
                - paragraph [ref=e98]: Each engine has a kind that identifies the underlying runtime, and each engine is either GPU-capable or CPU-only. A GPU model can only run on a GPU-capable engine, and a model intended for CPU nodes runs on a CPU-only engine.
                - heading "Automatic Engine SelectionDirect link to Automatic Engine Selection" [level=2] [ref=e99]:
                  - text: Automatic Engine Selection
                  - link "Direct link to Automatic Engine Selection" [ref=e100] [cursor=pointer]:
                    - /url: "#automatic-engine-selection"
                    - text: "#"
                - paragraph [ref=e101]:
                  - text: When you deploy a model, the engine setting defaults to
                  - strong [ref=e102]: engine (auto)
                ...
                - paragraph [ref=e103]:
                  ...
                  - code [ref=e104]: default · sglang
                  - text: .
                - heading "Supported Engine KindsDirect link to Supported Engine Kinds" [level=2] [ref=e105]:
                  - text: Supported Engine Kinds
                  - link "Direct link to Supported Engine Kinds" [ref=e106] [cursor=pointer]:
                    - /url: "#supported-engine-kinds"
                    - text: "#"
                - paragraph [ref=e107]: PaletteAI Inference Launchpad supports the following engine kinds.
                - table [ref=e108]:
                  - rowgroup [ref=e109]:
                    - row "Kind Hardware Summary" [ref=e110]:
                      - columnheader "Kind" [ref=e111]:
                        - strong [ref=e112]: Kind
                      - columnheader "Hardware" [ref=e113]:
                        - strong [ref=e114]: Hardware
                      - columnheader "Summary" [ref=e115]:
                        - strong [ref=e116]: Summary
                  - rowgroup [ref=e117]:
                    - row "vLLM GPU High-throughput GPU serving for large models." [ref=e118]:
                      - cell "vLLM" [ref=e119]
                      - cell "GPU" [ref=e120]
                      - cell "High-throughput GPU serving for large models." [ref=e121]
                    - row "SGLang GPU High-throughput GPU serving with support for advanced serving features." [ref=e122]:
                      - cell "SGLang" [ref=e123]
                      - cell "GPU" [ref=e124]
                      - cell "High-throughput GPU serving with support for advanced serving features." [ref=e125]
                    - row "Ollama CPU CPU-based serving for smaller models on nodes without a GPU." [ref=e126]:
                      - cell "Ollama" [ref=e127]
                      - cell "CPU" [ref=e128]
                      - cell "CPU-based serving for smaller models on nodes without a GPU." [ref=e129]
                    - row "llama.cpp CPU Lightweight CPU-based serving for smaller models on nodes without a GPU." [ref=e130]:
                      - cell "llama.cpp" [ref=e131]
                      - cell "CPU" [ref=e132]
                      - cell "Lightweight CPU-based serving for smaller models on nodes without a GPU." [ref=e133]
                - paragraph [ref=e134]: Serving features can vary by kind. For example, some kinds support reasoning and tool-calling for models that provide them, while others do not. The automatic option accounts for these differences when it matches an engine to a model.
                - heading "Manual Engine SelectionDirect link to Manual Engine Selection" [level=2] [ref=e135]:
                  - text: Manual Engine Selection
                  - link "Direct link to Manual Engine Selection" [ref=e136] [cursor=pointer]:
                    - /url: "#manual-engine-selection"
                    - text: "#"
                - paragraph [ref=e137]: Leave the engine on the automatic option unless you have a specific reason to pin a model to a particular engine, such as a serving feature that a specific kind provides. When you select an engine yourself, the appliance only offers engines that fit the model's hardware, so you cannot select a CPU-only engine for a GPU model or the reverse.
                - heading "ResourcesDirect link to Resources" [level=2] [ref=e138]:
                  - text: Resources
                  - link "Direct link to Resources" [ref=e139] [cursor=pointer]:
                    - /url: "#resources"
                    - text: "#"
                - list [ref=e140]:
                  - listitem [ref=e141]:
                    - link "Deploy a Model" [ref=e142] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/deploy-a-model/
                  - listitem [ref=e143]:
                    - link "Architecture" [ref=e144] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/explanation/architecture/
                  - listitem [ref=e145]:
                    - link "Certified Models by Hardware" [ref=e146] [cursor=pointer]:
              ...
              - generic [ref=e147]:
                - generic [ref=e149]:
                  ...
                  - list [ref=e150]:
                    ...
                    - listitem [ref=e153]:
                      - link "models" [ref=e154] [cursor=pointer]:
                        - /url: /paletteai-inference-launchpad/tags/models/
                    - listitem [ref=e155]:
                      - link "explanation" [ref=e156] [cursor=pointer]:
            ...
            - navigation "Docs pages" [ref=e164]:
              - link "Previous « Model Certification" [ref=e165] [cursor=pointer]:
                - /url: /paletteai-inference-launchpad/explanation/model-certification/
                - generic [ref=e166]: Previous
                - generic [ref=e167]: « Model Certification
              - link "Next Installation Architecture »" [ref=e168] [cursor=pointer]:
                - /url: /paletteai-inference-launchpad/explanation/installation-architecture/
                - generic [ref=e169]: Next
                - generic [ref=e170]: Installation Architecture »
          - list [ref=e173]:
            - listitem [ref=e174]:
              - link "Inference Engine Overview" [ref=e175] [cursor=pointer]:
                - /url: "#inference-engine-overview"
            - listitem [ref=e176]:
              - link "Automatic Engine Selection" [ref=e177] [cursor=pointer]:
                - /url: "#automatic-engine-selection"
            - listitem [ref=e178]:
              - link "Supported Engine Kinds" [ref=e179] [cursor=pointer]:
                - /url: "#supported-engine-kinds"
            - listitem [ref=e180]:
              - link "Manual Engine Selection" [ref=e181] [cursor=pointer]:
                - /url: "#manual-engine-selection"
            - listitem [ref=e182]:
              - link "Resources" [ref=e183] [cursor=pointer]:
                - /url: "#resources"
