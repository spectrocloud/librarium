            ...
            - article [ref=e99]:
                ...
                - list [ref=e101]:
                  ...
                  - listitem [ref=e106]:
                    - link "How-to Guides" [ref=e107] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/
                  - listitem [ref=e108]:
                    - generic [ref=e109]: Revoke or Delete a Client
              - generic [ref=e110]:
                - heading "Revoke or Delete a Client" [level=1] [ref=e112]
                - paragraph [ref=e113]:
                ...
                - heading "Find Expired or Revoked KeysDirect link to Find Expired or Revoked Keys" [level=2] [ref=e122]:
                  - text: Find Expired or Revoked Keys
                  - link "Direct link to Find Expired or Revoked Keys" [ref=e123] [cursor=pointer]:
                ...
                - paragraph [ref=e124]:
                  ...
                  - link "Client Lifecycle" [ref=e125] [cursor=pointer]:
                ...
                - list [ref=e126]:
                  ...
                  - listitem [ref=e133]:
                    - paragraph [ref=e134]:
                      - text: Select the
                      - strong [ref=e135]: API tokens
                      - text: section. Each token shows a state of
                      - strong [ref=e136]: active
                      - text: ","
                      - strong [ref=e137]: expired
                      - text: ", or"
                      - strong [ref=e138]: revoked
                      - text: .
                - paragraph [ref=e139]:
                  - text: The
                  - strong [ref=e140]: Usage
                  - text: page also shows a token's state in its per-token detail. For usage, refer to
                  - link "View Client Usage" [ref=e141] [cursor=pointer]:
                    - /url: /paletteai-inference-launchpad/how-to-guides/view-client-usage/
                  - text: .
                - heading "Revoke an API TokenDirect link to Revoke an API Token" [level=2] [ref=e142]:
                  - text: Revoke an API Token
                  - link "Direct link to Revoke an API Token" [ref=e143] [cursor=pointer]:
                ...
                - list [ref=e144]:
                  - listitem [ref=e145]:
                    - paragraph [ref=e146]:
                      - text: From the left main menu, select
                      - strong [ref=e147]: Access & Policy
                      - text: .
                  - listitem [ref=e148]:
                    - paragraph [ref=e149]:
                      - text: On the
                      - strong [ref=e150]: Clients & API tokens
                      - text: page, select the client to open its detail panel.
                  - listitem [ref=e151]:
                    - paragraph [ref=e152]:
                      - text: Select the
                      - strong [ref=e153]: API tokens
                      - text: section.
                  - listitem [ref=e154]:
                    - paragraph [ref=e155]:
                      - text: Find the token, then select the
                      - strong [ref=e156]: Revoke access
                      - text: icon (a prohibit symbol) at the end of its row, and confirm in the
                      - strong [ref=e157]: Revoke token
                      - text: dialog.
                - paragraph [ref=e158]: Revoking a token is immediate and cannot be undone.
                - heading "Suspend or Delete a ClientDirect link to Suspend or Delete a Client" [level=2] [ref=e159]:
                  - text: Suspend or Delete a Client
                  - link "Direct link to Suspend or Delete a Client" [ref=e160] [cursor=pointer]:
                ...
                - paragraph [ref=e161]:
                  ...
                  - link "Client Lifecycle" [ref=e162] [cursor=pointer]:
                    - /url: /paletteai-inference-launchpad/explanation/clients-and-quotas/#client-lifecycle
                  - text: .
                - paragraph [ref=e163]:
                  - text: Both actions are in the
                  - strong [ref=e164]: Overview
                ...
                - list [ref=e165]:
                  ...
                  - listitem [ref=e172]:
                    - paragraph [ref=e173]:
                      - text: Select the
                      - strong [ref=e174]: Overview
                      - text: section, then select
                      - strong [ref=e175]: Suspend
                      - text: or
                      - strong [ref=e176]: Delete
                      - text: ", and then confirm."
                - paragraph [ref=e177]:
                  - text: To restore a suspended client, select
                  - strong [ref=e178]: Resume
                  - text: in the
                  - strong [ref=e179]: Overview
                  - text: section.
                - heading "Next StepsDirect link to Next Steps" [level=2] [ref=e180]:
                  - text: Next Steps
                  - link "Direct link to Next Steps" [ref=e181] [cursor=pointer]:
                    - /url: "#next-steps"
                    - text: "#"
                - list [ref=e182]:
                  - listitem [ref=e183]:
                    - link "Create a Client" [ref=e184] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/create-a-client/
                  - listitem [ref=e185]:
              ...
              - generic [ref=e187]:
                - generic [ref=e189]:
                  ...
                  - list [ref=e190]:
                    - listitem [ref=e191]:
                      - link "paletteai-inference-launchpad" [ref=e192] [cursor=pointer]:
                    ...
                    - listitem [ref=e195]:
                      - link "api token" [ref=e196] [cursor=pointer]:
                        - /url: /paletteai-inference-launchpad/tags/api-token/
                    - listitem [ref=e197]:
                      - link "how-to" [ref=e198] [cursor=pointer]:
                        - /url: /paletteai-inference-launchpad/tags/how-to/
                - link "Edit this page" [ref=e201] [cursor=pointer]:
                  ...
                  - img [ref=e202]
                  - text: Edit this page
            - navigation "Docs pages" [ref=e206]:
              - link "Previous « View Client Usage" [ref=e207] [cursor=pointer]:
                - /url: /paletteai-inference-launchpad/how-to-guides/view-client-usage/
                - generic [ref=e208]: Previous
                - generic [ref=e209]: « View Client Usage
              - link "Next Use Claude Code »" [ref=e210] [cursor=pointer]:
                - /url: /paletteai-inference-launchpad/how-to-guides/use-claude-code/
                - generic [ref=e211]: Next
                - generic [ref=e212]: Use Claude Code »
          - list [ref=e215]:
            - listitem [ref=e216]:
              - link "Prerequisites" [ref=e217] [cursor=pointer]:
                - /url: "#prerequisites"
            - listitem [ref=e218]:
              - link "Find Expired or Revoked Keys" [ref=e219] [cursor=pointer]:
                - /url: "#find-expired-or-revoked-keys"
            - listitem [ref=e220]:
              - link "Revoke an API Token" [ref=e221] [cursor=pointer]:
                - /url: "#revoke-an-api-token"
            - listitem [ref=e222]:
              - link "Suspend or Delete a Client" [ref=e223] [cursor=pointer]:
                - /url: "#suspend-or-delete-a-client"
            - listitem [ref=e224]:
              - link "Next Steps" [ref=e225] [cursor=pointer]:
                - /url: "#next-steps"
  - button "Project Logo Ask AI" [ref=e226] [cursor=pointer]:
    - generic [ref=e229]:
      - img "Project Logo" [ref=e230]
      - paragraph [ref=e231]: Ask AI
```
