...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 2967px, received 1280px by 3020px. 12137 pixels (ratio 0.01 of all image pixels) are different.
        ...
        - generic [ref=e96]:
          - generic [ref=e98]:
            - article [ref=e99]:
              ...
              - generic [ref=e110]:
                ...
                - paragraph [ref=e231]:
                  ...
                  - link "Enable Vision Preprocessing" [ref=e234] [cursor=pointer]:
                    - /url: /paletteai-inference-launchpad/how-to-guides/enable-vision-preprocessing/
                  - text: .
              - generic [ref=e235]:
                - generic [ref=e237]:
                  ...
                  - list [ref=e238]:
                    ...
                    - listitem [ref=e241]:
                      - link "claude-code" [ref=e242] [cursor=pointer]:
                        - /url: /paletteai-inference-launchpad/tags/claude-code/
                    - listitem [ref=e243]:
                      - link "how-to" [ref=e244] [cursor=pointer]:
            ...
            - navigation "Docs pages" [ref=e252]:
              - link "Previous « Revoke or Delete a Client" [ref=e253] [cursor=pointer]:
                - /url: /paletteai-inference-launchpad/how-to-guides/revoke-or-delete-a-client/
                - generic [ref=e254]: Previous
                - generic [ref=e255]: « Revoke or Delete a Client
              - link "Next Use Cursor »" [ref=e256] [cursor=pointer]:
                - /url: /paletteai-inference-launchpad/how-to-guides/use-cursor/
                - generic [ref=e257]: Next
                - generic [ref=e258]: Use Cursor »
          - list [ref=e261]:
            - listitem [ref=e262]:
              - link "Prerequisites" [ref=e263] [cursor=pointer]:
                - /url: "#prerequisites"
            - listitem [ref=e264]:
              - link "Configure Claude Code" [ref=e265] [cursor=pointer]:
                - /url: "#configure-claude-code"
            - listitem [ref=e266]:
              - link "Verify the Connection" [ref=e267] [cursor=pointer]:
                - /url: "#verify-the-connection"
            - listitem [ref=e268]:
              - link "Request Routing and Quotas" [ref=e269] [cursor=pointer]:
                - /url: "#request-routing-and-quotas"
            - listitem [ref=e270]:
              - link "Next Steps" [ref=e271] [cursor=pointer]:
                - /url: "#next-steps"
  - button "Project Logo Ask AI" [ref=e272] [cursor=pointer]:
    - generic [ref=e275]:
      - img "Project Logo" [ref=e276]
      - paragraph [ref=e277]: Ask AI
```
