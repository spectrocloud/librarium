...
- Name: screenshot.docs.spec.ts >> Docs screenshots >> pathname /paletteai-inference-launchpad/tags/vision/
- Location: visuals/screenshot.docs.spec.ts:38:7

# Error details

```
Error: A snapshot doesn't exist at /home/runner/work/librarium/librarium/screenshots/screenshot.docs.spec.ts-snapshots/Docs-screenshots-pathname-paletteai-inference-launchpad-tags-vision-1-chromium-linux.png, writing actual.
```
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e36]:
      - generic [ref=e37]:
        - heading "2 docs tagged with \"vision\"" [level=1] [ref=e38]
        - link "View all tags" [ref=e39] [cursor=pointer]:
          - /url: /paletteai-inference-launchpad/tags/
      - generic [ref=e40]:
        - article [ref=e41]:
          - link "Enable Vision Preprocessing" [ref=e42] [cursor=pointer]:
            - /url: /paletteai-inference-launchpad/how-to-guides/enable-vision-preprocessing/
            - heading "Enable Vision Preprocessing" [level=2] [ref=e43]
          - paragraph [ref=e44]: Step-by-step guidance for platform operators on how to deploy a vision model alongside a text-only model and enable multimodal preprocessing so image requests are answered on the appliance.
        - article [ref=e45]:
          - link "Vision Preprocessing" [ref=e46] [cursor=pointer]:
            - /url: /paletteai-inference-launchpad/explanation/vision-preprocessing/
            - heading "Vision Preprocessing" [level=2] [ref=e47]
          - paragraph [ref=e48]: "An explanation of vision preprocessing in PaletteAI Inference Launchpad: how a text-only model answers questions about images, what clients see, and the limits that apply."
