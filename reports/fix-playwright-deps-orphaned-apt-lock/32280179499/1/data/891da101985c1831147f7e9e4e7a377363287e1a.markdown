...
- Name: screenshot.docs.spec.ts >> Docs screenshots >> pathname /paletteai-inference-launchpad/tags/metrics/
- Location: visuals/screenshot.docs.spec.ts:38:7

# Error details

```
Error: A snapshot doesn't exist at /home/runner/work/librarium/librarium/screenshots/screenshot.docs.spec.ts-snapshots/Docs-screenshots-pathname-paletteai-inference-launchpad-tags-metrics-1-chromium-linux.png, writing actual.
```
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - main [ref=e36]:
      - generic [ref=e37]:
        - heading "2 docs tagged with \"metrics\"" [level=1] [ref=e38]
      ...
      - generic [ref=e40]:
        ...
        - article [ref=e45]:
          - link "View Token Usage and Consumption Metrics" [ref=e46] [cursor=pointer]:
            - /url: /paletteai-inference-launchpad/how-to-guides/view-token-usage/
            - heading "View Token Usage and Consumption Metrics" [level=2] [ref=e47]
          - paragraph [ref=e48]: Step-by-step guidance for platform administrators on how to view token usage by model and by client, find the top consumers, and open the metrics dashboards on a PaletteAI Inference Launchpad appliance.
  - button "Project Logo Ask AI" [ref=e49] [cursor=pointer]:
    - generic [ref=e52]:
      - img "Project Logo" [ref=e53]
      - paragraph [ref=e54]: Ask AI
```
