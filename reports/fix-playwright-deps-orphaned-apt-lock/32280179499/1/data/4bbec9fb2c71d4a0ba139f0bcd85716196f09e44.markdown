...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1280px by 1683px, received 1280px by 1855px. 21177 pixels (ratio 0.01 of all image pixels) are different.
                ...
                - list [ref=e103]:
                  ...
                  - listitem [ref=e108]:
                    - link "How-to Guides" [ref=e109] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/
                  - listitem [ref=e110]:
                    - generic [ref=e111]: View Client Usage
              - generic [ref=e112]:
                - heading "View Client Usage" [level=1] [ref=e114]
                - paragraph [ref=e115]:
                ...
                - list [ref=e119]:
                  ...
                  - listitem [ref=e121]:
                    ...
                    - link "Create a Client" [ref=e122] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/create-a-client/
                    - text: .
                  - listitem [ref=e123]: Console access with permission to view usage.
                - heading "View Usage by ClientDirect link to View Usage by Client" [level=2] [ref=e124]:
                  - text: View Usage by Client
                  - link "Direct link to View Usage by Client" [ref=e125] [cursor=pointer]:
                ...
                - list [ref=e126]:
                  ...
                  - listitem [ref=e130]:
                    - paragraph [ref=e131]:
                      - text: Select the
                      - strong [ref=e132]: By client
                      - text: tab.
                  - listitem [ref=e133]:
                    - paragraph [ref=e134]: Select a client.
                - paragraph [ref=e135]: "The client view shows:"
                - list [ref=e136]:
                  - listitem [ref=e137]: Per-client totals for local input tokens, local output tokens, egress tokens, and egress cost.
                  - listitem [ref=e138]: A per-token table with each token's label, prefix, status, last-used time, creation time, expiration, request count, input tokens, output tokens, total tokens, and cost.
                  - listitem [ref=e139]: The percentage of each quota used, which indicates how much of each limit is still available.
                  - listitem [ref=e140]: A conversation-routing breakdown that shows which models handled the client's requests.
                - generic [ref=e141]:
                  - generic [ref=e142]:
                    - img [ref=e144]
                    - text: info
                  - paragraph [ref=e147]:
                    - text: The figures cover the period set in the
                    - strong [ref=e148]: Data window
                    - text: menu in the page header. When a figure cannot cover that whole period, the card displays a note naming the span it does cover.
                - heading "Further ReadingDirect link to Further Reading" [level=2] [ref=e149]:
                  - text: Further Reading
                  - link "Direct link to Further Reading" [ref=e150] [cursor=pointer]:
                    - /url: "#further-reading"
                    - text: "#"
                - list [ref=e151]:
                  - listitem [ref=e152]:
                    - link "View Token Usage" [ref=e153] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/view-token-usage/
                    - text: covers the rest of the
                    - strong [ref=e154]: Usage
                    - text: page, including per-model usage and finding the top consumers.
                  - listitem [ref=e155]:
                    - link "Usage Metrics Reference" [ref=e156] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/reference/usage-metrics-reference/
                    - text: defines every metric, column, and export field.
                - heading "Next StepsDirect link to Next Steps" [level=2] [ref=e157]:
                  - text: Next Steps
                  - link "Direct link to Next Steps" [ref=e158] [cursor=pointer]:
                    - /url: "#next-steps"
                    - text: "#"
                - list [ref=e159]:
                  - listitem [ref=e160]:
                    - link "Set and Manage Client Quotas" [ref=e161] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/manage-client-quotas/
                  - listitem [ref=e162]:
                    - link "Revoke or Delete a Client" [ref=e163] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/revoke-or-delete-a-client/
              - generic [ref=e164]:
                - generic [ref=e166]:
                  - text: "Tags:"
                  - list [ref=e167]:
                    ...
                    - listitem [ref=e170]:
                      - link "clients" [ref=e171] [cursor=pointer]:
                        - /url: /paletteai-inference-launchpad/tags/clients/
                    - listitem [ref=e172]:
                      - link "usage" [ref=e173] [cursor=pointer]:
                        - /url: /paletteai-inference-launchpad/tags/usage/
                    - listitem [ref=e174]:
                      - link "how-to" [ref=e175] [cursor=pointer]:
                        - /url: /paletteai-inference-launchpad/tags/how-to/
                - link "Edit this page" [ref=e178] [cursor=pointer]:
                  ...
                  - img [ref=e179]
                  - text: Edit this page
            - navigation "Docs pages" [ref=e183]:
              - link "Previous « View Token Usage" [ref=e184] [cursor=pointer]:
                - /url: /paletteai-inference-launchpad/how-to-guides/view-token-usage/
                - generic [ref=e185]: Previous
                - generic [ref=e186]: « View Token Usage
              - link "Next Revoke or Delete a Client »" [ref=e187] [cursor=pointer]:
                - /url: /paletteai-inference-launchpad/how-to-guides/revoke-or-delete-a-client/
                - generic [ref=e188]: Next
                - generic [ref=e189]: Revoke or Delete a Client »
          - list [ref=e192]:
            - listitem [ref=e193]:
              - link "Prerequisites" [ref=e194] [cursor=pointer]:
                - /url: "#prerequisites"
            - listitem [ref=e195]:
              - link "View Usage by Client" [ref=e196] [cursor=pointer]:
                - /url: "#view-usage-by-client"
            - listitem [ref=e197]:
              - link "Further Reading" [ref=e198] [cursor=pointer]:
                - /url: "#further-reading"
            - listitem [ref=e199]:
              - link "Next Steps" [ref=e200] [cursor=pointer]:
                - /url: "#next-steps"
