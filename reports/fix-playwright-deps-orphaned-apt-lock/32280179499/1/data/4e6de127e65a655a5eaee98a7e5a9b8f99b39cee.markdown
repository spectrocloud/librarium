            ...
            - article [ref=e101]:
                ...
                - list [ref=e103]:
                  ...
                  - listitem [ref=e108]:
                    - link "How-to Guides" [ref=e109] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/
                  - listitem [ref=e110]:
                    - generic [ref=e111]: Generate an API Token
              - generic [ref=e112]:
                - heading "Generate an API Token" [level=1] [ref=e114]
                - paragraph [ref=e115]:
                  ...
                  - link "Create a Client" [ref=e117] [cursor=pointer]:
                    - /url: /paletteai-inference-launchpad/how-to-guides/create-a-client/
                  - text: .
                ...
                - list [ref=e120]:
                  ...
                  - listitem [ref=e122]:
                    ...
                    - link "Create a Client" [ref=e123] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/create-a-client/
                    - text: .
                  - listitem [ref=e124]: Console access with permission to create API tokens. Creating a token can require operator access.
                - heading "Generate an API TokenDirect link to Generate an API Token" [level=2] [ref=e125]:
                  - text: Generate an API Token
                  - link "Direct link to Generate an API Token" [ref=e126] [cursor=pointer]:
                    - /url: "#generate-an-api-token"
                    - text: "#"
                - paragraph [ref=e127]: If an administrator already gave you an API token, you can use it and skip the following steps.
                - list [ref=e128]:
                  - listitem [ref=e129]:
                    - paragraph [ref=e130]:
                ...
                - generic [ref=e158]:
                  - generic [ref=e159]:
                    - img [ref=e161]
                    - text: warning
                  - paragraph [ref=e164]: The console shows the token only once and stores only a hash of it. Copy it now. If you lose it, revoke the token and create a new one.
                - heading "Next StepsDirect link to Next Steps" [level=2] [ref=e165]:
                  - text: Next Steps
                  - link "Direct link to Next Steps" [ref=e166] [cursor=pointer]:
                    - /url: "#next-steps"
                    - text: "#"
                - paragraph [ref=e167]: Use the token to connect a coding assistant to the appliance.
                - list [ref=e168]:
                  - listitem [ref=e169]:
                    - link "Use Claude Code" [ref=e170] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/use-claude-code/
                  - listitem [ref=e171]:
                    - link "Use Cursor" [ref=e172] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/use-cursor/
                  - listitem [ref=e173]:
                    - link "Use OpenAI Codex" [ref=e174] [cursor=pointer]:
                      - /url: /paletteai-inference-launchpad/how-to-guides/use-codex/
                  - listitem [ref=e175]:
              ...
              - generic [ref=e177]:
                - generic [ref=e179]:
                  ...
                  - list [ref=e180]:
                    - listitem [ref=e181]:
                      - link "paletteai-inference-launchpad" [ref=e182] [cursor=pointer]:
                        - /url: /paletteai-inference-launchpad/tags/paletteai-inference-launchpad/
                    - listitem [ref=e183]:
                      - link "api-token" [ref=e184] [cursor=pointer]:
                        - /url: /paletteai-inference-launchpad/tags/api-token/
                    - listitem [ref=e185]:
                      - link "how-to" [ref=e186] [cursor=pointer]:
                        - /url: /paletteai-inference-launchpad/tags/how-to/
                - link "Edit this page" [ref=e189] [cursor=pointer]:
                  ...
                  - img [ref=e190]
                  - text: Edit this page
            - navigation "Docs pages" [ref=e194]:
              - link "Previous « Create a Client" [ref=e195] [cursor=pointer]:
                - /url: /paletteai-inference-launchpad/how-to-guides/create-a-client/
                - generic [ref=e196]: Previous
                - generic [ref=e197]: « Create a Client
              - link "Next Set and Manage Client Quotas »" [ref=e198] [cursor=pointer]:
                - /url: /paletteai-inference-launchpad/how-to-guides/manage-client-quotas/
                - generic [ref=e199]: Next
                - generic [ref=e200]: Set and Manage Client Quotas »
          - list [ref=e203]:
            - listitem [ref=e204]:
              - link "Prerequisites" [ref=e205] [cursor=pointer]:
                - /url: "#prerequisites"
            - listitem [ref=e206]:
              - link "Generate an API Token" [ref=e207] [cursor=pointer]:
                - /url: "#generate-an-api-token"
            - listitem [ref=e208]:
              - link "Next Steps" [ref=e209] [cursor=pointer]:
                - /url: "#next-steps"
  - button "Project Logo Ask AI" [ref=e210] [cursor=pointer]:
    - generic [ref=e213]:
      - img "Project Logo" [ref=e214]
      - paragraph [ref=e215]: Ask AI
```
