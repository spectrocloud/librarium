        ...
        docs: {
          ...
          async sidebarItemsGenerator({ defaultSidebarItemsGenerator, ...args }) {
            ...
            const filteredDocs = docs.filter((doc) => {
              // Allow a page to opt out of the autogenerated sidebar without
              // being unlisted (which would add noindex). Set
              // `sidebar_custom_props.hide_from_sidebar: true` in the page's frontmatter.
              if (doc.frontMatter?.sidebar_custom_props?.hide_from_sidebar) {
                return false;
              }
              return true;
            });
