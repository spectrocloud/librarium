...
const config = {
  ...
  plugins: ["docusaurus-plugin-sass", ["@docusaurus/plugin-content-docs", {
    ...
    config: {
      palette: {
        ...
        downloadUrl: "https://github.com/spectrocloud/librarium/blob/master/docs/api-content/api-docs/palette-apis.json",
        sidebarOptions: {
          groupPathsBy: "tag",
  ...
  }], pluginImportFontAwesomeIcons, function () {
    return {
  ...
  themeConfig: /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
  {
    ...
    navbar: {
      ...
      items: [{
        ...
        dropdownItemsAfter: [...Object.entries(ArchivedVersions).map(([versionName, versionUrl]) => ({
          href: versionUrl,
          label: versionName
        }))]
      }, {
