...
| **Connect Private Cloud Gateway** | Select this option to connect to a Private Cloud Gateway (PCG) if you have a PCG deployed in your environment. Refer to the PCG [Architecture](../clusters/pcg/architecture.md) page to learn more about a PCG.                                                                                        |
