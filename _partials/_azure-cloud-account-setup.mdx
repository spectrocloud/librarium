...
<!-- prettier-ignore-start --> Beginning with Palette version 4.6.x, a <VersionedLink text="Private Cloud Gateway (PCG)" url="/clusters/pcg"/> is required for <VersionedLink text="self-hosted Palette" url="/enterprise-version/enterprise-version"/> 
