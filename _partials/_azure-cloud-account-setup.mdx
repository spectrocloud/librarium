...
<!-- prettier-ignore-start --> Beginning with Palette version 4.6.x, a <VersionedLink text="Private Cloud Gateway (PCG)" url="/clusters/pcg"/> is required to add an Azure US Government account.

 If you are using a <VersionedLink text="self-hosted Palette" url="/enterprise-version/enterprise-version"/> or <VersionedLink text="VerteX" url="/vertex/vertex"/> instance, a PCG is not required for Azure US Government accounts unless you configure both an Azure Public Cloud and Azure US Government account on the same installation. If do not configure a PCG for Azure US Government clusters, you must install two instances of Palette or VerteX: one for Azure Public Cloud clusters and one for Azure US Government clusters. <!-- prettier-ignore-end -->
