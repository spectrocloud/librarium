...
The `System.*` privileges are added to all [custom vSphere roles](https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere-supervisor/8-0/create-a-custom-role.html) by default.
