...
Visit the <VersionedLink text="VM User Roles and Permissions" url="/vm-management/rbac/vm-roles-permissions"/> for more information about VMO and permissions requirements.