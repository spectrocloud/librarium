...
For example, you can create development and production clusters from a single template. Both clusters run the same software
...
- Deploy two clusters (development and production) from the same template
- Use
  [cluster profile variables](/profiles/cluster-profiles/create-cluster-profiles/define-profile-variables/)
