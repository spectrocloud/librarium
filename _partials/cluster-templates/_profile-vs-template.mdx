...
<TabItem value="profiles" label="Cluster Profiles">
    ...
    1. In the **Cluster setup type** window, choose **Cluster Profiles > Add Cluster Profile**.
...
<TabItem value="template" label="Cluster Templates">
    ...
    1. In the **Cluster setup type** window, choose **Cluster Template > Select Cluster Template**.
