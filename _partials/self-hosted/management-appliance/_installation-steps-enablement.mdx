...
8. Restart the nodes to start the installation process. Once the nodes are booted from the ISO, the GRand Unified
...
9. In the Palette TUI, provide credentials for the initial account. This account will be used to log in to Local UI and for SSH access to the node.
...
18. Log in to Local UI using the credentials you provided in step 9.
