...
- Access to the [Artifact Studio](https://artifact-studio.spectrocloud.com/) to download the {props.iso} ISO and, if using the slim **Appliance ISO**, the accompanying content bundle.
