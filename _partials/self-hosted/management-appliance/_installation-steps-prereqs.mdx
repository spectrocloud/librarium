...
- Access to the Palette [Artifact Studio](https://artifact-studio.spectrocloud.com/) to download the {props.iso} ISO. Refer to the <VersionedLink text="Artifact Studio guide" url="/downloads/artifact-studio"/> guide for instructions on how to access and download the ISO.
