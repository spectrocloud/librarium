...
Learn how to configure and install Secure Boot for Palette Management Appliance below.
  ...
  1. Power on the server. Execute the following command to create a virtual CD/DVD drive containing a ISO file with the `MOK.der` certificate.
  ...
  12. Save the changes and reboot the server.
