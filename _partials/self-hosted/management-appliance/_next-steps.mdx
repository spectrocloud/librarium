...
- Plan how to back up and restore your {props.app} installation. Refer to the <PaletteVertexUrlMapper edition={props.edition} text="Back Up and Restore" palettePath="/enterprise-version/install-palette/palette-management-appliance-backup-restore" vertexPath="/vertex/install-palette-vertex/vertex-management-appliance-backup-restore"/> guide for the full procedure.
