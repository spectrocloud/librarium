...
- 
  <PaletteVertexUrlMapper
   ...
   /> - Displays the type of environment the tenant is working in, such as **CLASSIFIED** or **TOP SECRET**. This banner is displayed on all system console and tenant screens, including login screens. Classification banners cascade to _all_ tenants.
