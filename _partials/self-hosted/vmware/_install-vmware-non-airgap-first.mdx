...
2.  Create a vSphere VM and template folder with the name `spectro-templates`. Ensure this folder is accessible by the
    user account you use to deploy the {props.version} installation.

3.  Find the Open Virtual Appliance (OVA) download URL corresponding to your {props.version} version in the
