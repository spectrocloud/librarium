...
- Ensure the following software is installed and available in the environment hosting the file server. For example, if
  you deployed an airgapped instance of {props.edition} to VMware using an For example, if you deployed an airgapped instance of {props.edition} to VMware using an <PaletteVertexUrlMapper
    edition={props.edition}
    text="OVA"
