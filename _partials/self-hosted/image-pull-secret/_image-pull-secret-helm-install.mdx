...
| **File**                                      | **Parameter**                                                                                                               |
| --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| <code>{props.helm}/values.yaml</code> | <code><PaletteVertexUrlMapper edition={props.edition} text="global.imagePullSecret.dockerConfigJson" palettePath="/install-palette/install-on-kubernetes/palette-helm-ref/" vertexPath="/install-palette-vertex/install-on-kubernetes/vertex-helm-ref/" /></code> |
