...
4. Verify that the **Pull secret** field displays a masked secret.
    ...
    {props.edition === 'vertex'
      ? <img src="/configure-image-pull-secret_palette.webp" alt="Configuring an image pull secret in the system console." />
      : <img src="/configure-image-pull-secret_vertex.webp" alt="Configuring an image pull secret in the system console"" />
    }
