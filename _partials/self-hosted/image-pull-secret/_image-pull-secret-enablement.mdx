...
If the system console is unavailable and you need to immediately configure the image pull secret so that clusters can pull images, you
can use the terminal to create the secret in the management cluster so it can propagate to the workload clusters. For more information, refer to
[Breakglass scenario: Manually create secret in management plane](/troubleshooting/system-management/#breakglass-pull-secret).
