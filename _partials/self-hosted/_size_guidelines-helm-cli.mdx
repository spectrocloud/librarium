...
This section lists resource requirements for {props.version} for various capacity levels. In {props.version}, the terms _small_,
_medium_, and _large_ are used to describe the instance size of worker pools that {props.version} is installed on. The following
...
the performance of {props.version} with the recommended maximum number of deployed nodes and clusters. Exceeding these limits
...
| -------------------- | --------- | ------- | ---------- | ----------- | ------------------------- | ------------------------ | --------------------- | ------------------------ | ----------------------------------- |
| Small                | 3         | 16      | 32 GB      | 60 GB       | 20 GB                     | 4 GB                     | 2                     | 1000                     | 100                                 |
| Medium (Recommended) | 3         | 32      | 64 GB      | 100 GB      | 60 GB                     | 8 GB                     | 4                     | 3000                     | 300                                 |
| Large                | 3         | 64      | 100 GB     | 120 GB      | 80 GB                     | 12 GB                    | 6                     | 5000                     | 500                                 |

:::info

The Spectro manifest requires approximately 10 GB of storage. {props.version} deployed clusters use the manifest to identify what images to pull for each microservice that makes up {props.version}.
