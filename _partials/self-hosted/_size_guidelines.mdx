...
<TabItem label="Appliance Framework" value="appliance-framework">

| **Size**             | **Total Nodes** | **Node CPU** | **Node Memory** | **Node Storage** | **MongoDB Node Storage Limit** | **MongoDB Node Memory Limit** | **MongoDB Node CPU Limit** | **Total Deployed Workload Cluster Nodes** | **Deployed Clusters with 10 Nodes** |
| -------------------- | --------- | ------- | ---------- | ----------- | ------------------------- | ------------------------ | --------------------- | ------------------------ | ----------------------------------- |
| Small                | 3         | 8       | 16 GB      | 450 GB       | 20 GB                     | 4 GB                     | 2                     | 1000                     | 100                                 |
| Medium (Recommended) | 3         | 16      | 32 GB      | 450 GB      | 60 GB                     | 8 GB                     | 4                     | 3000                     | 300                                 |
| Large                | 3         | 32      | 64 GB      | 450 GB      | 80 GB                     | 12 GB                    | 6                     | 5000                     | 500                                 |
