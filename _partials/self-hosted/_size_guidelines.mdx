...
This section lists resource requirements for Palette for various capacity levels. In {props.edition}, the terms _small_,
...
The Spectro manifest requires approximately 10 GB of storage. Palette VerteX deployed clusters use it to pull the required images from the Spectro Cloud packs and image registry. In the case of airgap, it is used to pull the required images from the OCI registry configured in the airgap environment.
:::
