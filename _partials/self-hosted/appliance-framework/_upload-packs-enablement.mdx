...
2. Ensure to select the **{props.iso} Appliance** product on the **Product selection** step and build your pack
...
4. Log in to the Local UI of the leader host of the {props.version} management cluster. By default, the Local UI is accessible
