...
For GitHub Container Registry (GHCR), paste the default chart values, and make changes as needed. For other registries, modify the existing values as necessary.
