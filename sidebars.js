...
const privacyIconSVG = `
  <svg style="margin-right: 16px;" role="img" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512">
...
function createPrivacyLink(extraClass = '') {
  return `
    <a class="menu__link ${extraClass}" href="#" onClick="UC_UI.showSecondLayer();">
      ${privacyIconSVG}Privacy Settings
    </a>
  `;
}

const privacyLinkDocs = createPrivacyLink();
const privacyLinkTutorial = createPrivacyLink('privacy-settings');
