...
const sidebars = {
  ...
  tutorialSidebar: [
    ...
    },
    {
      type: "html",
      value:
        "<div class='category'><i class='category-icon fa-solid fa-eye'></i>Profiles<hr class='category-divider' /></div>",
      defaultStyle: true,
    },
    { type: "autogenerated", dirName: "tutorials/profiles" },
    {
      type: "html",
      value:
        "<div class='category'><i class='category-icon fa-solid fa-eye'></i>Cluster Deployment<hr class='category-divider' /></div>",
      defaultStyle: true,
    },
    { type: "autogenerated", dirName: "tutorials/cluster-deployment" },
    {
      type: "html",
      value:
        "<div class='category'><i class='category-icon fa-solid fa-eye'></i>Cluster Management<hr class='category-divider' /></div>",
      defaultStyle: true,
    },
    ...
    { type: "autogenerated", dirName: "tutorials/edge" },
    {
      type: "html",
      value:
        "<div class='category'><i class='category-icon fa-solid fa-eye'></i>Self-hosted<hr class='category-divider' /></div>",
      defaultStyle: true,
    },
    // { type: "autogenerated", dirName: "tutorials/self-hosted" },
    {
      type: "html",
      value:
        "<div class='category'><i class='category-icon fa-solid fa-eye'></i>Virtual Machine Orchestration<hr class='category-divider' /></div>",
      defaultStyle: true,
    },
    // { type: "autogenerated", dirName: "tutorials/vmo" },
    {
      type: "html",
      value:
        "<div class='category'><i class='category-icon fa-solid fa-eye'></i>Tenant Admin and Security<hr class='category-divider' /></div>",
      defaultStyle: true,
    },
