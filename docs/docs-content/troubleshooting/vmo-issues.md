...
To address this issue, use the following steps to update the `storageClass` attribute for the VMO cluster. This issue
was resolved in Palette version 4.5.3.
