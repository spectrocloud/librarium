...
On Edge Native clusters, restores of security-hardened applications (such as Argo CD) may fail with the affected application
pods stuck in the `Init:CreateContainerConfigError` state, showing
