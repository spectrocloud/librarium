...
On Edge Native clusters configured with Longhorn, restores of security-hardened applications such as Argo CD may fail
with affected application pods stuck in the `Init:CreateContainerConfigError` state, showing
