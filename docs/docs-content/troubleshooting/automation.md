...
due to a changed encryption passphrase or other reasons, you can update the CLI configuration file and the component
installation configuration files by using the following steps.
