...
For guidance in using the CLI, review [Access Cluster with CLI](/clusters/cluster-management/palette-webctl#access-cluster-with-cli). To learn more about kubectl pod commands, refer to the [Kubernetes](https://kubernetes.io/docs/reference/generated/kubectlkubectl-commands#get) documentation.
