...
1. A Spectro Cloud account. Visit the [sign-up](https://www.spectrocloud.com/free-tier) page to create an account.
...
Download the `ghcr.io/spectrocloud/tutorials:1.0.6` image to your local machine. The Docker image includes the necessary tools. 
<br />

```bash
docker pull ghcr.io/spectrocloud/tutorials:1.0.6
```
