...
synchronize the Helm registry with Palette. Refer to [Helm Registry](helm-charts.md#synchronization-behavior) to learn
more about the synchronization behavior of Helm registries.
