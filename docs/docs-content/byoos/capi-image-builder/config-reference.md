...
| `airgap_ip` | The IP address or hostname of the airgap support VM that has the required dependencies. Refer to the [self-hosted Palette](../../self-hosted-setup/palette/vmware/setup/airgap/airgap.md) and [Palette Vertex](../../self-hosted-setup/vertex/vmware/setup/airgap/airgap.md) Environment Setup pages for instructions on how to deploy an airgap support VM. | Yes      |
