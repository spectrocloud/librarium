...
- The following artifacts must be available in the root home directory of the airgap support VM. You can download the
  ...
  - [Rocky Linux ISO](https://dl.rockylinux.org/pub/rocky/8/isos/x86_64/Rocky-8-latest-x86_64-dvd1.iso) version 8 or 9.
    Ensure you download the `x86_64-dvd1.iso` file and not the `x86_64-boot.iso` file, and make sure you have its SHA256
    checksum available. This guide uses Rocky 8 as an example. Refer to the
