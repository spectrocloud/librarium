...
account to Palette with the **Connect Private Cloud Gateway** option toggled. You can then use the PCG to deploy and
delete clusters in the cloud environment connected to the PCG.
