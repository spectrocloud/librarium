...
4. Open the **values.yaml** file and populate the `ociImageRegistry` section with your OCI registry values. Refer to the
   ...
   | `mirrorRegistries`   | [image swap format](https://github.com/phenixblue/imageswap-webhook/blob/master/docs/configuration.md) for pulling images. The placeholders require a `/v2/` endpoint if your OCI registry supports the Docker Registry protocol v2; otherwise, container pull images will fail. For example: `docker.io::harbor.example.org/v2/airgap-images/docker.io,gcr.io::harbor.example.org/v2/airgap-images/gcr.io,ghcr.io::harbor.example.org/v2/airgap-images/ghcr.io,k8s.gcr.io::harbor.example.org/v2/airgap-images/k8s.gcr.io,registry.k8s.io::harbor.example.org/v2/airgap-images/registry.k8s.io,quay.io::harbor.example.org/v2/airgap-images/quay.io,us-docker.pkg.dev::harbor.example.org/v2/airgap-images/us-docker.pkg.dev` | Yes      |
   ...
   config:
     ...
     ociImageRegistry:
       ...
       insecureSkipVerify: false
       caCert: ""
       mirrorRegistries: "docker.io::harbor.example.org/v2/airgap-images/docker.io,gcr.io::harbor.example.org/v2/airgap-images/gcr.io,ghcr.io::harbor.example.org/v2/airgap-images/ghcr.io,k8s.gcr.io::harbor.example.org/v2/airgap-images/k8s.gcr.io,registry.k8s.io::harbor.example.org/v2/airgap-images/registry.k8s.io,quay.io::harbor.example.org/v2/airgap-images/quay.io,us-docker.pkg.dev::harbor.example.org/v2/airgap-images/us-docker.pkg.dev"
   ```
...
8. Replace the placeholder values with the actual values for your custom image registry. Use the same values that you
   ...
   | `MIRROR_REGISTRIES` | A comma-separated list of mirror registries in the [image swap format](https://github.com/phenixblue/imageswap-webhook/blob/master/docs/configuration.md) to use for pulling images. For example: `docker.io::harbor.example.org/v2/airgap-images/docker.io,gcr.io::harbor.example.org/v2/airgap-images/gcr.io,ghcr.io::harbor.example.org/v2/airgap-images/ghcr.io,k8s.gcr.io::harbor.example.org/v2/airgap-images/k8s.gcr.io,registry.k8s.io::harbor.example.org/v2/airgap-images/registry.k8s.io,quay.io::harbor.example.org/v2/airgap-images/quay.io,us-docker.pkg.dev::harbor.example.org/v2/airgap-images/us-docker.pkg.dev` | Yes      |
   ...
   stringData:
     ...
     INSECURE: "false"
     CA_CERT: ""
     MIRROR_REGISTRIES: docker.io::harbor.example.org/v2/airgap-images/docker.io,gcr.io::harbor.example.org/v2/airgap-images/gcr.io,ghcr.io::harbor.example.org/v2/airgap-images/ghcr.io,k8s.gcr.io::harbor.example.org/airgap-images/k8s.gcr.io,registry.k8s.io::harbor.example.org/v2/airgap-images/registry.k8s.io,quay.io::harbor.example.org/v2/airgap-images/quay.io,us-docker.pkg.dev::harbor.example.org/v2/airgap-images/us-docker.pkg.dev
   kind: Secret
   metadata:
     name: registry-info
     namespace: jet-system
...
5. Replace the placeholder values with the actual values for your custom image registry. Refer to the table below for a
   ...
   stringData:
     ...
     INSECURE: "false"
     CA_CERT: ""
     MIRROR_REGISTRIES: docker.io::harbor.example.org/v2/airgap-images/docker.io,gcr.io::harbor.example.org/v2/airgap-images/gcr.io,ghcr.io::harbor.example.org/v2/airgap-images/ghcr.io,k8s.gcr.io::harbor.example.org/v2/airgap-images/k8s.gcr.io,registry.k8s.io::harbor.example.org/v2/airgap-images/registry.k8s.io,quay.io::harbor.example.org/v2/airgap-images/quay.io,us-docker.pkg.dev::harbor.example.org/v2/airgap-images/us-docker.pkg.dev
   kind: Secret
   metadata:
     name: registry-info
     namespace: jet-system
...
3. Issue the following command to verify that the secret containing the image registry configuration is created.
   ...
   ```shell hideClipboard
   docker.io::harbor.example.org/v2/airgap-images/docker.io,gcr.io::harbor.example.org/v2/airgap-images/gcr.io,ghcr.io::harbor.example.org/v2/airgap-images/ghcr.io,k8s.gcr.io::harbor.example.org/v2/airgap-images/k8s.gcr.io,registry.k8s.io::harbor.example.org/v2/airgap-images/registry.k8s.io,quay.io::harbor.example.org/v2/airgap-images/quay.io,us-docker.pkg.dev::harbor.example.org/v2/airgap-images/us-docker.pkg.dev
   ```
     ...
     [plugins."io.containerd.grpc.v1.cri".registry]
       [plugins."io.containerd.grpc.v1.cri".registry.mirrors]
         [plugins."io.containerd.grpc.v1.cri".registry.mirrors."docker.io"]
           endpoint = ["harbor.example.org/v2/airgap-images/docker.io"]
         [plugins."io.containerd.grpc.v1.cri".registry.mirrors."gcr.io"]
           endpoint = ["harbor.example.org/v2/airgap-images/gcr.io"]
         [plugins."io.containerd.grpc.v1.cri".registry.mirrors."ghcr.io"]
           endpoint = ["harbor.example.org/v2/airgap-images/ghcr.io"]
         [plugins."io.containerd.grpc.v1.cri".registry.mirrors."k8s.gcr.io"]
           endpoint = ["harbor.example.org/v2/airgap-images/k8s.gcr.io"]
         [plugins."io.containerd.grpc.v1.cri".registry.mirrors."registry.k8s.io"]
           endpoint = ["harbor.example.org/v2/airgap-images/registry.k8s.io"]
         [plugins."io.containerd.grpc.v1.cri".registry.mirrors."quay.io"]
           endpoint = ["harbor.example.org/v2/airgap-images/quay.io"]
         [plugins."io.containerd.grpc.v1.cri".registry.mirrors."us-docker.pkg.dev"]
           endpoint = ["harbor.example.org/v2/airgap-images/us-docker.pkg.dev"]
   ```
