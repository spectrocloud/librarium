...
- The HyperShift-hosted OpenShift model is not supported on [Palette VerteX](../../../../vertex/vertex.md). This is
  because Federal Information Processing Standards (FIPS) support is not currently available for the
