...
| **Dedicate node pool for system pods** | Reserves the node pool for Palette system pods, so you can safely apply taints to every other node pool in the cluster. Available only on EKS and GKE clusters. When enabled, custom taints cannot be added to this pool. To learn more, refer to [Taints and system pods](./taints.md#system-pod-taints).                                                                                                                                                                                                                                                                          |
