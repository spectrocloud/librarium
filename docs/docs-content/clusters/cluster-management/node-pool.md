...
| **Additional Labels**                  | Optional labels apply placement constraints on a pod. For example, you can add a label to make a node eligible to receive the workload. To learn more, refer to the [Node Labels](./node-labels.md) guide. For Edge Native clusters, you can also apply labels to a specific node in the pool. Refer to [Node-level Taints and Labels for Edge Native](#node-level-taints-and-labels-for-edge-native).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
