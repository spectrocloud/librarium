...
| **Distribution**                                                        |    **OS**    |     **Local**      |    **Central**     |  **Single Node**   |   **Multi-Node**   |    **Non-FIPS**    |    **Overlay**     |
| ----------------------------------------------------------------------- | :----------: | :----------------: | :----------------: | :----------------: | :----------------: | :----------------: | :----------------: |
| <VersionedLink text="K3s" url="/integrations/packs/?pack=edge-k3s" />   | Ubuntu 24.04 | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: | :white_check_mark: |
