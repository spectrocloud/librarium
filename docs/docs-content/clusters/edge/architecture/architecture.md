...
| Palette Optimized Canonical                                                                                     | Ubuntu | Canonical Kubernetes            | Calico, Cilium | Rook Ceph |

:::preview
    
The **Palette Optimized Canonical** distribution is a Tech Preview feature and is subject to change. Do not use this feature in production workloads.
