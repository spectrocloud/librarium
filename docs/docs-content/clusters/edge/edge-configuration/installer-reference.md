...
| `stylus.externalRegistries`    | Use this parameter to configure external registries to load content from another source. Review [External Registries](#external-registries) for more information.                        | None        |
...
specified in the user data. This allows the Edge host to find and pull images from the local Harbor registry that came
