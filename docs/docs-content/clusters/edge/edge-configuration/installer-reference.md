...
| `stylus.site.remoteShell.disable` | When set to `true`, disables remote shell access to the host. The field is supported for Edge hosts built with Palette agent version 4.7.c-canvos or later.                                                                                                 | boolean                          | `false` |
