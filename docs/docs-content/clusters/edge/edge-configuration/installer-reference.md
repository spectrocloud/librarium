...
| `stylus.disableTui`                                         | Disables the ability to interact with the Palette Terminal User Interface (TUI), preventing users from modifying Edge host and network settings. Edge host information is still displayed when set to `true`.                                                                                                                                                                                          | boolean | `false`   |
