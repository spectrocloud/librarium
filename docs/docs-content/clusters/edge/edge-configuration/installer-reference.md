...
| `stylus.externalRegistries.registryMappingRules` | A list of key-pair rules to map domain names to external registries. Refer to [Registry Mapping Rules](#registry-mapping-rules) for more details. | Map of `string:string` | None    |
...
| Parameter         | Description                                                              | Type             | Default |
| ----------------- | ------------------------------------------------------------------------ | ---------------- | ------- |
| `domain`          | The domain of the registry.                                              | String           | None    |
| `username`        | The username to authenticate with the registry.                          | String           | None    |
...
| `stylus.site.clusterId`          | The ID of the cluster the Edge host belongs to.                                                                                                                                                                                                             | String                  | None    |
...
| `stylus.site.projectName`        | The name of the project to which the Edge host belongs.                                                                                                                                                                                                     | String                  | None    |
| `stylus.site.projectUid`         | The ID of the project to which the Edge host belongs.                                                                                                                                                                                                       | String                  | None    |
| `stylus.site.registrationURL`    | The URL that operators use to register the Edge host with Palette.                                                                                                                                                                                          | String                  | None    |
| `stylus.site.tags`               | A parameter object you can use to provide optional key-value pairs. Refer to the [Tags](#tags) section to learn more.                                                                                                                                       | Map of `string:any`     | None    |
...
| Parameter                                         | Description                                                                                                                | Type                             | Default |
| ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------- | ------- |
| `stylus.site.network.httpProxy`                   | The URL of the HTTP proxy endpoint.                                                                                        | String                           | None    |
| `stylus.site.network.httpsProxy`                  | The URL of the HTTPS proxy endpoint.                                                                                       | String                           | None    |
| `stylus.site.network.noProxy`                     | The list of IP addresses or CIDR ranges to exclude from routing through the proxy.                                         | String                           | None    |
| `stylus.site.network.interfaces`                  | The network settings for each interface. This parameter accepts a map of keys named after your NICs (for example, `eth0`). | Map of `string:NetworkInterface` | None    |
| `stylus.site.network.interfaces.[NIC].ipAddress`  | The assigned IP address to the network interface.                                                                          | String                           | None    |
| `stylus.site.network.interfaces.[NIC].mask`       | The network mask for the assigned IP address.                                                                              | String                           | None    |
...
| `stylus.site.network.interfaces.[NIC].gateway`    | The network gateway IP address.                                                                                            | String                           | None    |
| `stylus.site.network.interfaces.[NIC].nameserver` | The IP address of the DNS nameserver for this interface.                                                                   | String                           | None    |
| `stylus.site.network.nameserver`                  | The IP address of the global DNS nameserver to route requests to.                                                          | String                           | None    |
...
| `install.bind_mounts.extra-dirs-rootfs`        | The list of folders to bind mount from the installer to the Edge host's root file system. These folders are created in the `rootfs` path during installation. | Array of strings | None    |
...
| `install.partitions.persistent.size`           | The size of the persistent partition.                                                                                                                         | Integer          | None    |
| `install.partitions.persistent.fs`             | The file system type for the persistent partition.                                                                                                            | String           | None    |
| `install.partitions.extra-partitions`          | The list of extra partitions to create. Each item accepts `name`, `size`, `fs`, and `label`.                                                                  | Array of objects | None    |
| `install.partitions.extra-partitions[*].name`  | The name of the extra partition.                                                                                                                              | String           | None    |
