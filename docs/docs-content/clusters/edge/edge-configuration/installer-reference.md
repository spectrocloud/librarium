...
| `stylus.disableTui`                                         | Disables the ability to configure hosts and network settings from the Palette Terminal User Interface (TUI). Edge host information is still displayed when set to `true`.                                                                                                                                                                                                                              | boolean | `false`   |
