...
Local Edge clusters have new content compatibility and pre-upgrade requirements in Palette 4.9.33. Content bundles built
against 4.9.27 or earlier are incompatible with 4.9.33 Edge installers, and existing local Edge clusters must apply
