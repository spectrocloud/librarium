...
- If you are not using [Trusted Boot](../../trusted-boot/trusted-boot.md), you must disable Unified Extensible Firmware
  Interface (UEFI) Secure Boot on the Edge host before installing the FIPS-compliant Edge Installer ISO. The FIPS
