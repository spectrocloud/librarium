---
sidebar_label: "Build EdgeForge AWS Cloud Image"
title: "Build EdgeForge AWS Cloud Image"
...
In this guide, you will use the CanvOS utility to build provider images that enable deploying Edge clusters on AWS EC2.
The aws-cloud-image target takes a CanvOS raw disk image and imports it into AWS, creating and registering an Amazon
Machine Image (AMI) that can be used to launch EC2 instances. This target automates the workflow from raw image creation
through AMI registration in AWS.
