...
step in practice. Refer to [Build Edge Artifacts](../palette-canvos.md) for a how-to that covers how to build both
...
guide when you do not require the specialized configurations above.
