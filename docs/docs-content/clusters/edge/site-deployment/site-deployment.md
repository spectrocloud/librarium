...
for Palette Edge, and to [Deploy Edge Hosts on MAAS](maas-deployment.md) for step-by-step instructions on uploading images to MAAS and deploying an Edge host using the MAAS UI.
