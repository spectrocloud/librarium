...
- Edge Installer ISO file. Check out the [EdgeForge Workflow](/clusters/edge/edgeforge-workflow/build-images/) to learn
  how to create an Edge Installer image or use the default Edge Installer image.
...
- USB disk containing the content bundle ISO. You can avoid this by creating a custom installer. Refer to the
  [Build Images](../edgeforge-workflow/build-images.md) guide.
...
You can validate the Edge host is ready for the site installation by simulating a site deployment on one of the Edge
hosts. The simulation process will require you to complete the installation process and reset the device after the
validation.
...
- Edge Installer ISO file. Check out the [build images](../edgeforge-workflow/build-images.md) guide to learn how to
