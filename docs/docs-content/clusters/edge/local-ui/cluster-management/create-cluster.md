...
6. If your selected cluster profile has [Cluster Profile Variables](../../../../profiles/cluster-profiles/create-cluster-profiles/define-profile-variables/define-profile-variables.md), you will now be prompted to enter the values for those
