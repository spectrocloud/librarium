...
2. Press the **ALT + RIGHT ARROW** keys, or **CTRL + ALT + F1** on a keyboard connected to the Edge host. Replace **ALT** with
   **OPTION** on a Mac keyboard. This will bring up the login screen for you to log in to the terminal.
