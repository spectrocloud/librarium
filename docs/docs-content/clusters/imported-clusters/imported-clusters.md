...
| Deploy and manage [add-on cluster profiles](../../profiles/cluster-profiles/create-cluster-profiles/create-addon-profile/create-addon-profile.md) <br /> _Generic requires Palette **4.9.x** or later_                                                                                       |        :x:         |    :white_check_mark:    |
