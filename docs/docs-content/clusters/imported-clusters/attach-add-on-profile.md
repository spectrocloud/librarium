...
* An add-on cluster profile. Refer to the [Create an Add-on Profile](../../profiles/cluster-profiles/create-cluster-profiles/create-addon-profile.md) to learn how to create an add-on cluster profile.
