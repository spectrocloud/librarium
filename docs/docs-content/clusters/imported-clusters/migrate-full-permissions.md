...
7.  Open a terminal on your local workstation and verify you are in the correct
    ...
    file. Your current context is indicated with an asterisk (`*`).
...
4. Verify that you can interact with the **Profile**, **Workloads**, **Scan**, and **Backups** tabs. The **Migrate To
   Full Permissions** button should also no longer be available.
