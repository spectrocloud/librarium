...
access credentials) or secure compliance validation using your SC2S Access Portal (SCAP) credentials to register your
AWS Secret Cloud account in Palette VerteX.
...
5. Toggle on **Secure Compliance Validation** and enter the following information.
   ...
   [Palette VerteX](../../../../self-hosted-setup/vertex/vertex.md) installations.
