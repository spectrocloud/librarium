...
[Prepare Environment](./prepare-environment.md) page to prepare Outpost to use Palette.
...
- Configure a [capacity task](https://docs.aws.amazon.com/outposts/latest/userguide/modify-instance-capacity.html) to
  ...
  `c6id.metal` instance size on your on-premises environment.

- Create a [subnet](https://docs.aws.amazon.com/outposts/latest/server-userguide/launch-instance.html#create-subnet) to
  use are your Outpost LNI and allow your local workloads to connect to outgoing traffic on your local infrastructure.
