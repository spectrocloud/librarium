...
10. Provide the following node pool and cloud configuration information. If you will be using Fargate profiles, you can
    ...
    | **Dedicate node pool for system pods**                      | Enable if you want the node pool to run system pods only. For more information, refer to [Dedicated node pool for system pods](../../cluster-management/node-pool.md#dedicated-system-pod-pool).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
