...
6. Click **Add Cluster Profile**, select the EKS cluster profile you created and click **Next**. Palette displays the
...
15. RBAC configuration is required when you configure custom OIDC. You must map a set of users or groups to a Kubernetes
...
16. Click **Validate** and review the cluster configuration and settings summary.

17. Click **Finish Configuration** to deploy the cluster.
