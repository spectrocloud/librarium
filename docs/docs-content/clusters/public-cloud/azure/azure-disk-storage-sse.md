...
8. On the right side of the editor, expand the **Presets** drop-down menu, and select **Disable Encryption Using
   Customer-Managed Key** to use CMK with SSE.
...
Follow these steps to confirm that encryption is disabled on your Azure VM disks.
