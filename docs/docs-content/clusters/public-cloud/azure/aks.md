...
- A Secure Shell (SSH) key that you have pre-configured in your Azure environment. Only RSA SSH keys are supported when deploying
  Azure AKS clusters. Refer to the [SSH Keys](../../cluster-management/ssh/ssh-keys.md) guide for
