...
Create an Add-on profile with special-purpose functionality that you can reuse among multiple clusters. Add-on profiles do not contain core infrastructure packs. 
