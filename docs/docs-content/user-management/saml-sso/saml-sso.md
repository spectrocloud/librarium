...
- OpenID Connect (OIDC) - OIDC is a more modern protocol designed for web and mobile applications. OIDC is built on top of [OAuth 2.0](https://www.rfc-editor.org/rfc/rfc6749), a widely used authorization framework. OIDC supports distributed identity providers and supports social login providers such as Google or GitHub.
...
- [Palette SSO with Microsoft Entra ID](palette-sso-entra-id.md)
