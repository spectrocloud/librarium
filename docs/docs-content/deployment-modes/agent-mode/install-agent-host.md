...
4. Issue the command below to create the **user-data** file and configure your host declaratively.
   ...
   - The host will not shut down and will instead reboot after the agent is installed, with
     ...
     vSphere deployments. If your environment does not require kube-vip, set `stylus.vip.skip` to `true`. See the [Edge Installer Configuration Reference](../../clusters/edge/edge-configuration/installer-reference.md) to learn more about user
     data configuration.
...
5. Issue the command below to create the **userdata** file and configure your host declaratively.
   ...
   deployments. If your environment does not require kube-vip, set `stylus.vip.skip` to `true`. See the [Edge Installer Configuration Reference](../../clusters/edge/edge-configuration/installer-reference.md) to learn more about user data configuration.
