...
14. Next, set your Palette GCP account name as a variable. Replace `<gcp-account-name>` with the name under which you
...
15. Next, fetch the ID of your GCP cloud account registered in Palette by invoking the `cloudaccounts` Palette API.
...
17. Create the GCP IaaS cluster.
