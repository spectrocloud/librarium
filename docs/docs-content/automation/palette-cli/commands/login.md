...
| -              | `--console-url`           | Palette URL (omit for interactive login). For environments configured with SSO, specify the organization-specific endpoint using this flag when deploying [PCGs](../../../clusters/pcg/deploy-pcg/deploy-pcg.md).                                                                                                                                                           | string   |
...
| -              | `--acknowledge-banner`    | Acknowledge Banner Check (automatically accepts banner)                                                                                                                                                                                                                                                                                                                     | boolean  |
