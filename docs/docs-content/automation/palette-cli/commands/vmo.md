...
[Import and Deploy OVAs to Palette VMO](../../../vm-management/vmo-pack/create-manage-vm/advanced-topics/deploy-import-ova.md)
...
Refer to
[Migrate a VM to a VMO cluster using the Palette CLI](../../../vm-management/vmo-pack/create-manage-vm/advanced-topics/migrate-vm-kubevirt.md#prerequisites)
...
Refer to the
[Migrate a VM to a VMO cluster using the Palette CLI](../../../vm-management/vmo-pack/create-manage-vm/advanced-topics/migrate-vm-kubevirt.md)
