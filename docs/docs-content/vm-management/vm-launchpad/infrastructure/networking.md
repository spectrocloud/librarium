...
<!-- SCAFFOLD (PVM-1183). Content reflects the 4.10.a NAD-based bridge VLAN filtering feature. Several UI labels and pack values still need confirmation before publish (see VERIFY markers). Do NOT publish until the feature ships in 4.10.a. -->
...
<!-- VERIFY(PVM-1183): confirm the exact "Clear & Retry" control label on the Networks page in the shipped 4.10.a build. -->
...
<!-- VERIFY(PVM-1183): confirm the nadDiscovery default and the exact allowedVlans key path against the shipped 4.10.a pack values. -->
