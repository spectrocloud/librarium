...
In airgap clusters, VMs cannot reach external package repositories. Launchpad:
...
- Commands to install the guest agent, such as `apt-get install -y qemu-guest-agent` for Debian/Ubuntu.
