...
Take the following steps to delete a namespace created using the VMO UI.

1. From the VMO left main menu, select **Infrastructure** > **Namespaces**.
2. Right-click the namespace you want to delete and select **Delete Namespace**. This can only be done for namespaces
   with a **VMO Status** of **Created**. Alternatively, use the **Delete** icon.
3. Enter the namespace you are deleting, and select **Delete**.
