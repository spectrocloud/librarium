...
For clusters and VMs created using the VM Launchpad Appliance, refer to our VM Launchpad [Overcommit and Memory Optimization](../../launchpad-for-vms/vmo-overcommit-memory-optimization-appliance.md) guide.
