...
For clusters and VMs created using the VM Launchpad, refer to our VM Launchpad [Overcommit and Memory Optimization](../../vm-launchpad/vmo-overcommit-memory-optimization-appliance.md) guide.
