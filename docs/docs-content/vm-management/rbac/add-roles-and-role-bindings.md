...
- A cluster profile with the **Virtual Machine Orchestrator** add-on pack configured. Check out the
  [Create a VMO Profile](../vmo-pack/create-vmo-profile.md) guide to learn more.
...
[Deploy VM From a Template](../vmo-pack/create-manage-vm/deploy-vm-from-template.md) guide to get started with the
deployment process.
