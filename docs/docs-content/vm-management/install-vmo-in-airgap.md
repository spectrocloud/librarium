...
3. Refer to the [Palette Additional Packs](../downloads/additional-packs.md) page to download and install the
...
4. If you are planning to deploy VMs with direct network access, repeat step three to install a load balancer pack of
   ...
   (**airgap-pack-lb-metallb**), which you can find in [Palette Additional Packs](../downloads/additional-packs.md).
