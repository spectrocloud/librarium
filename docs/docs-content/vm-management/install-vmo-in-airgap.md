...
3. Refer to the [Palette Additional Packs](../downloads/self-hosted-palette/additional-packs.md) page to download and install the
   **airgap-pack-virtual-machine-orchestrator** and **airgap-pack-spectro-proxy** packs. You will need these packs for
   both Proxied and Direct network configuration.
...
4. If you are planning to deploy VMs with direct network access, repeat step three to install a load balancer pack of
   ...
   (**airgap-pack-lb-metallb**), which you can find in [Palette Additional Packs](../downloads/self-hosted-palette/additional-packs.md).
