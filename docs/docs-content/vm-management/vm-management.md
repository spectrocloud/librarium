...
Refer to the [VMs section](./launchpad-for-vms/virtual-machines/virtual-machines.md) to
learn how to create and manage golden images, templates, and snapshots.
