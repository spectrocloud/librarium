...
4. Select the **VMware vSphere** from the **Provider type** dropdown. Once the provider type is selected, additional
   fields appear. The following table describes the details you need to fill in for the provider.
   ...
   | **Skip certificate validation**      | Enabling this option bypasses x509 certificate authority (CA) verification.                               |
...
3. All namespaces are displayed by default. If you want to view a specific namespace, use the **Namespace** drop-down
   menu in the top-left corner to select your Kubernetes namespace for the migration.
