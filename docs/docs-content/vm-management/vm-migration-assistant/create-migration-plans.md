...
9. For the **Storage map** step, choose to **Use an existing storage map** or **Use new storage map**.
   ...
   [Launchpad for VMs appliance](../launchpad-for-vms/launchpad-for-vms.md), require explicit storage map settings for migrated
...
11. For the **Migration type** step, choose whether this will be a warm or cold migration. Refer to
    [Verified Migrations](./vm-migration-assistant.md#verified-migrations) for a list of verified migration
    combinations.
