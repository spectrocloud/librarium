...
[Launchpad for VMs](launchpad-for-vms/install-vmla-iso.md) is the recommended way to deploy a new Palette Virtual Machine
...
[Environment Setup](./vmo-pack/environment-setup.md) and [Create a VMO Profile](./vmo-pack/create-vmo-profile.md)
pages.
