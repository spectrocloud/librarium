...
Compute nodes can be placed into [maintenance mode](../../clusters/cluster-management/maintenance-mode.md) using Palette or manually using the `cordon` and `drain` commands. The
