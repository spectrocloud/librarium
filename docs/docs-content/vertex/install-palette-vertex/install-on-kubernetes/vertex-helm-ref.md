...
| `type`                                 | Specifies the type of ingress controller to use as the primary ingress. Options are `"nginx"` or `"traefik"`. <br /> <br /> **WARNING:** The internal [Ingress Nginx](https://www.kubernetes.dev/blog/2025/11/12/ingress-nginx-retirement/) controller used by Palette management plane services is now [deprecated](../../../release-notes/announcements.md#deprecations) and will be removed in a future release. To avoid service disruptions, set `ingress.type` to `traefik`.                                                                                                                                                                   | String   | `"traefik"`       |
