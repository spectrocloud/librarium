...
Beginning with 4.8.c, Palette VerteX deploys both a Traefik ingress controller and an Nginx ingress controller. Traefik
is the default ingress controller and handles traffic routing to the Palette VerteX control plane; Nginx, which is
...
your cluster already uses an ingress controller, set `ingress.enabled` to `false`.
...
| `type`                                 | Specifies the type of ingress controller to use as the primary ingress. Options are `"nginx"` or `"traefik"`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | String   | `"traefik"`       |
...
| `ingress.ingressStaticIP`              | Specify a static IP address for the ingress load balancer service. If empty, a dynamic IP address is assigned to the load balancer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | String   | `""`              |
