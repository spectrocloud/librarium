...
| **Parameters**                         | **Description**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | **Type** | **Default value** |
| -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ----------------- |
| `enabled`                              | Specifies whether to deploy the Traefik ingress controller. Set to `false` if you do not want Palette VerteX to deploy an ingress controller, such as if you have an existing ingress service configured on the Kubernetes cluster.                                                                                                                                                                                                                                                                                                                                                                                                                  | Boolean  | `true`            |
