...
- Palette VerteX deploys both a Traefik ingress controller and an Nginx ingress controller. Traefik is the default
  ...
  [deprecated in Palette VerteX](../../../../release-notes/announcements.md#deprecations). It will be removed in a
  future release. If you are deploying an ingress controller as part of your Palette VerteX installation, set
