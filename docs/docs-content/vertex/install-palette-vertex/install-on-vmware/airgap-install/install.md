...
4.  Select the desired OS you want to use for the installation. Review the table below for more information about each
    ...
    | **Red Hat Linux Enterprise** | Red Hat Linux Enterprise provides access to Red Hat Enterprise Linux.                                                          | Red Hat subscription and a custom RHEL vSphere template with Kubernetes. Review the [RHEL and PXK](../../../../byoos/usecases/vmware/rhel-pxk.md) guide to learn how to create the required template. |
...
16. Log in to the system console using the credentials provided in the Enterprise Cluster Details output. After login,
    ...
    [password requirements](../../../system-management/account-management/credentials.md) documentation page to learn
    more about the password requirements.
