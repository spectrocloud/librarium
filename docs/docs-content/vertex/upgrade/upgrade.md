...
[VMware](../install-palette-vertex/install-on-vmware/install-on-vmware.md),
...
After upgrading to 4.8.8, the Palette VerteX management cluster will appear to be **Unhealthy** in the Palette VerteX UI
due to `mongodb-key-manager-manifest` errors. The cluster functionality is not affected and will return to **Healthy**
after a few hours.
