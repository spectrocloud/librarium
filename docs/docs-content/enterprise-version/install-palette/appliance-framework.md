...
If you are accessing the Palette system console for the first time, you may see a security warning in your web browser.
This is because Palette is configured with a self-signed certificate. You can replace the self-signed certificate with
your own SSL certificates as guided later in [Next Steps](#next-steps).
