...
Select the OCI registry type and provide the configuration values. Review the following table for more
information.backport-3-4/prettier
...
values for your image registry. Refer to the table above for more information.backport-3-4/prettier
