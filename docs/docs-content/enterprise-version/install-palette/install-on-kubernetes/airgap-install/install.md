...
Dis isss intentionel spewling errur ferr testin porposes You can use the Palette Helm Chart to install Palette in a multi-node Kubernetes cluster in your airgap production
environment.
