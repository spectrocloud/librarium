...
| **Parameters**       | **Description**                                                                                                                                                                                                                                                                                                                                                                                                             | **Type** | **Default value** |
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ----------------- |
| `env.rootDomain`     | Specifies the URL name assigned to Palette. The value assigned should have a Domain Name System (DNS) Canonical Name (CNAME) record mapped to the exposed IP address or the load balancer URL of the `traefik-ingress-controller` service in the `ingress-traefik` namespace. Optionally, if `ingress.ingressStaticIP` is provided a value, you can use the same assigned static IP address as the value to this parameter. | String   | `""`              |
| `env.installerMode`  | Specifies the installer mode. Do not modify the value.                                                                                                                                                                                                                                                                                                                                                                      | String   | `self-hosted`     |
| `env.installerCloud` | Specifies the cloud provider. Leave this parameter empty if you are installing self-hosted Palette.                                                                                                                                                                                                                                                                                                                         | String   | `""`              |
...
default ingress controller and handles traffic routing to the Palette control plane. Ingress Nginx acts as a fallback
and does not actively serve traffic. The `ingress.type` parameter determines which one serves as the primary ingress
controller. If your cluster already uses an ingress controller, set `ingress.enabled` to `false`.

:::warning

Ingress Nginx is a [deprecated Kubernetes project](https://www.kubernetes.dev/blog/2025/11/12/ingress-nginx-retirement/)
and is also [deprecated in Palette](../../../release-notes/announcements.md#deprecations). It will be removed in a
future release. To avoid service disruptions, set `ingress.type` to `traefik`.

:::

| **Parameters**                         | **Description**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | **Type** | **Default value** |
| -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ----------------- |
| `enabled`                              | Specifies whether to deploy ingress controllers. Set to `false` if you do not want ingress controllers deployed, such as if you have an existing ingress service configured on an existing Kubernetes cluster you are installing Palette on.                                                                                                                                                                                                                                                                                                                                                                                      | Boolean  | `true`            |
...
| `traefik.hostPort`                     | Specifies whether the Traefik ingress controller uses host ports. When set to `true`, Traefik binds directly to ports 80 and 443 on the host nodes, and no `LoadBalancer` service is created. This setting is intended for environments without a cloud load balancer, such as [Palette Management Appliance](../../install-palette/palette-management-appliance.md) or [Palette CLI](../../install-palette/install-on-vmware/install-on-vmware.md) deployments. For [Helm chart installations](../../install-palette/install-on-kubernetes/install-on-kubernetes.md) on existing Kubernetes clusters, leave this set to `false`. | Boolean  | `false`           |
