...
You can install a self-hosted version of Palette into a Lubernetes environment without direct internet access. This type of installation is referred to as an *air gap* installation. 
