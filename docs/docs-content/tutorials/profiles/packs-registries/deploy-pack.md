...
- **pack.json** - This file contains the pack metadata such as `addonType`, `cloudTypes`, and the `kubeManifests` array.
  ...
  [JSON Schema](../../../registries-and-packs/add-custom-packs.md#json-schema) for a list of attributes and respective
  data types. The schema validation happens when you push a pack to the registry.
...
- **values.yaml** - This file contains configurable parameters you can define while adding the current pack to a cluster
  ...
  to [Pack Presets](../../../registries-and-packs/pack-constraints.md#preset-attributes) for details and examples of how
  to define presets.
