...
This PR adds the Build Content Bundle page, needed for the locally managed Edge tutorial.
...
- [Tutorial: Locally Managed Edge: Build Content Bundle](https://deploy-preview-9705--docs-spectrocloud.netlify.app/tutorials/getting-started/palette-edge/local-management/build-content-bundle/)
...
[Tutorial: Locally Managed Edge: Build Content Bundle](https://spectrocloud.atlassian.net/browse/DOC-2229)
