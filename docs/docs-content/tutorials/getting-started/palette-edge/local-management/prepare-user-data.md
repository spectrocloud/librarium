...
This tutorial focuses on building locally managed Edge devices, and is part of the
...
also includes an `install` parameter block to power off the host once the Edge installation completes. This is to allow
safe removal the USB device after installation.
