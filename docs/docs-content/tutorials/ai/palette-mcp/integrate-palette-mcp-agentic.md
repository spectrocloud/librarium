...
Next, navigate to the left main menu and select **Profiles**. Select the **tutorial-profile** cluster profile. Then,
select the three-dot menu > **Delete**. Confirm the deletion by entering the cluster profile name when prompted.
