...
title: "Launchpad for AI Inference Engines"
description:
  "An explanation of inference engines in Launchpad for AI, including automatic engine selection, the supported engine
  kinds, and when to override the automatic choice."
hide_table_of_contents: false
sidebar_position: 2
tags: ["launchpad-for-ai", "models", "explanation"]
...
This page explains what an inference engine is in Launchpad for AI, how the appliance selects one automatically, and
when you might choose one yourself. It gives you the background to make an informed choice when you
...
Launchpad for AI supports the following engine kinds.
