...
8.  Select how many hours you want the **Upgrade window** to last. Values range from 1 - 24 hours. Updates will be deployed to clusters gradually during the upgrade window.
