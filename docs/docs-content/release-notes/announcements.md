...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- | ---------------- |
| The `/kubeconfig` [API endpoint](/api/introduction) has now been deprecated. Use the `/kubeconfigclient` API endpoint to download kubeconfig files instead.                                                                                                                                                                                             | _To be announced_   | April 5, 2026    |
...
blog for further information. <!-- prettier-ignore-end -->  
| _To be announced_ | November 22, 2025 | | The `stylus.includeTui`
[Edge Installer Configuration](../clusters/edge/edge-configuration/installer-reference.md) flag is now deprecated. The
Terminal User Interface (TUI) is always enabled regardless of the `stylus.includeTui` value. | May 24, 2026 | November
22, 2025 | |
[EKS-optimized Amazon Linux 2 (AL2) AMIs](https://docs.aws.amazon.com/eks/latest/userguide/eks-ami-deprecation-faqs.html)
will be disabled in Palette from January 10, 2026 and removed on 4 April, 2026. When disabled, you will no longer be
...
guide for help with migrating workloads. | April 18, 2026 | October 18, 2025 | | The
[Palette Edge CLI](../downloads/cli-tools.md#palette-edge-cli) is deprecated and will be removed in a future release. We
recommend using the [Palette CLI](../automation/palette-cli/palette-cli.md) for the creation and management of content
bundles. Refer to the [Build Content Bundle](../clusters/edge/edgeforge-workflow/palette-canvos/build-content-bundle.md)
guide for further information. | April 26, 2026 | May 25, 2025 |
...
| Change                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Release | Date               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ------------------ |
| OpenStack is no longer supported in Palette. We recommend migrating your workloads to another supported [data center environment](../clusters/data-center/data-center.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | 4.8.47  | April 5th, 2026    |
