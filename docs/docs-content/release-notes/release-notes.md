...
- Improved Edge cluster upgrade experience. In the past, most upgrades would trigger a repave when not always necessary.
  ...
  is required. Refer to the [Edge Cluster Upgrade Behavior](/clusters/edge/cluster-management/upgrade-behavior.md) page
  to learn more about the upgrade behavior.
