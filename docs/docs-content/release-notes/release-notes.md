...
## May 31, 2025 - Release 4.6.31 {#release-notes-4.6.c}
...
- Starting with version 4.6.31, Palette and VerteX installations need to be activated after 30 days. Once you install or
  upgrade Palette or VerteX to version 4.6.31 or later, you have 30 days to activate it. During this time, you have
...
The [CanvOS](https://github.com/spectrocloud/CanvOS) version corresponding to the 4.6.31 Palette release is 4.6.21.
