...
- The <VersionedLink text="Tigera Operator" url="/integrations/packs/?pack=tigera-operator" /> pack version 3.31.3 fails to install on airgapped environments. Refer to the <VersionedLink text="Additional Details" url="/integrations/packs/?pack=tigera-operator&tab=custom" /> tab for additional information. 
<!-- prettier-ignore-end -->
