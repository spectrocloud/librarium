...
- A FIPS-compiled vCluster pack is now available, letting strict-FIPS tenants provision virtual clusters using FIPS
  140-3 approved cryptography. The FIPS-compiled pack is automatically selected when deploying virtual clusters on VerteX.
