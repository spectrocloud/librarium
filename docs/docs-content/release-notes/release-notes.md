...
- A new [Getting Started tutorial](../getting-started/getting-started.md) for deploying [locally managed Edge clusters](../tutorials/getting-started/palette-edge/local-management/palette-edge.md) is now available.  
