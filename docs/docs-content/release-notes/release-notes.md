...
- The dependencies of the `imageswap` Palette image was updated to the latest versions, ensuring that it has the latest
  security patches.

<!-- https://spectrocloud.atlassian.net/browse/PCP-6564 -->
<!-- prettier-ignore-start -->

- Fixed an issue that caused Azure IaaS clusters using <VersionedLink text="Palette eXtended Kubernetes (PXK)" url="/integrations/packs/?pack=kubernetes" /> version 1.32.13 or earlier get stuck when upgrading to a PXK version in the 1.33.x series.

<!-- https://spectrocloud.atlassian.net/browse/PE-8590 -->

- Fixed an issue that prevented Edge hosts using <VersionedLink text="Palette eXtended Kubernetes Edge (PXK-E)" url="/integrations/packs/?pack=edge-k8s" /> from upgrading version 1.34.5 to version 1.35.2 due to `content.sh` failing silently with exit code `127`.
...
## April 24, 2026 - Component Updates {#component-updates-2026-17}

The following components have been updated for Palette version 4.8.6 - 4.8.51.

| Component                                                                                                         | Version |
| ----------------------------------------------------------------------------------------------------------------- | ------- |
| [Artifact Studio](../downloads/artifact-studio.md)                                                                | 4.8.11  |
| [Spectro Cloud Terraform provider](https://registry.terraform.io/providers/spectrocloud/spectrocloud/latest/docs) | 0.28.6  |
| [Spectro Cloud Crossplane provider](https://marketplace.upbound.io/providers/crossplane-contrib/provider-palette) | 0.28.6  |
| [Palette Management Appliance](../enterprise-version/install-palette/palette-management-appliance.md)             | 4.8.52  |
| [VerteX Management Appliance](../vertex/install-palette-vertex/vertex-management-appliance.md)                    | 4.8.52  |

### Improvements

<!-- https://spectrocloud.atlassian.net/browse/PLT-2182 -->
...
- The
  ...
  `max` to positive values, `count` must be equal to `min`.
...
- [April 24, 2026 - Component Updates](#component-updates-2026-17) <!-- omit in toc -->
...
### Palette Enterprise {#palette-enterprise-4-8-c}
...
<!-- https://spectrocloud.atlassian.net/browse/PEM-10017 -->
...
<!-- https://spectrocloud.atlassian.net/browse/PEM-9414 -->

- Fixed an issue that caused cluster update event messages to be published intermittently, causing delays in
  [cluster profile update](../profiles/cluster-profiles/modify-cluster-profiles/update-cluster-profile.md) deployment.

<!-- https://spectrocloud.atlassian.net/browse/PEM-9496 -->

- Fixed an issue that caused [cluster liveness probes](../clusters/cluster-management/health-alerts.md) on multiple
...
- The `/kubeconfig` [API endpoint](/api/introduction) has now been deprecated. Use the `/kubeconfigclient` API endpoint
  to download kubeconfig files instead.
...
- The [AWS Outposts](../clusters/public-cloud/aws/aws-outpost/aws-outpost.md) section provides guidance about how
  Palette supports deployment of [Edge hosts](../clusters/public-cloud/aws/aws-outpost/configure-edge-on-aws-outpost.md)
  on [AWS Outposts](https://aws.amazon.com/outposts/).

### Packs

<!-- https://spectrocloud.atlassian.net/browse/PAC-3865 -->
<!-- https://spectrocloud.atlassian.net/browse/PAC-3875 -->
<!-- https://spectrocloud.atlassian.net/browse/PAC-3629 -->

| Pack Name           | Layer      | Non-FIPS           | FIPS               | New Version |
| ------------------- | ---------- | ------------------ | ------------------ | ----------- |
| Amazon EBS CSI      | CSI        | :white_check_mark: | :x:                | 1.57.1      |
| BYOOS (OpenShift)   | OS         | :white_check_mark: | :x:                | 1.0.0       |
| Flannel             | CNI        | :x:                | :white_check_mark: | 0.28.1      |
| OVN-Kubernetes      | CNI        | :white_check_mark: | :x:                | 4.20.13     |
| Flux2               | Add-on     | :white_check_mark: | :x:                | 2.18.2      |
| Harbor              | Add-on     | :white_check_mark: | :x:                | 1.18.3      |
| HyperShift Operator | Add-on     | :white_check_mark: | :x:                | 4.20.0      |
| HyperShift Operator | Add-on     | :white_check_mark: | :x:                | 4.19.0      |
...
| OpenShift           | Kubernetes | :white_check_mark: | :x:                | 4.20.13     |
| OpenShift           | Kubernetes | :white_check_mark: | :x:                | 4.19.7      |
