...
## February 14, 2026 - Release 4.8.X {#release-notes-4.8.b}
...
- Palette and VerteX installations now use [Traefik for Kubernetes ingress](https://doc.traefik.io/traefik/reference/install-configuration/providers/kubernetes/kubernetes-ingress/). The migration is seamless for new and existing Palette installations. This change follows the [Ingress NGINX Retirement](https://kubernetes.io/blog/2025/11/11/ingress-nginx-retirement/).
...
The [CanvOS](https://github.com/spectrocloud/CanvOS) version corresponding to the 4.8.X Palette release is 4.8.b.
