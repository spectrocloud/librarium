...
- The ability to **Force sync** [registries](../registries-and-packs/registries/registries.md) has been added to
  **Tenant Settings** > **Registries**. Use this option to interrupt and restart an ongoing synchronization process if
  the synchronization has been in progress for at least one hour.
