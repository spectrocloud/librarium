...
- Fixed an issue where the Spectro Ubuntu mirror did not support ARM64 architecture and the FIPS builder lacked ARM64
  variants.
...
- Fixed security vulnerabilities (CVE-2026-40224, CVE-2026-28390) in the palette-agent by rebuilding it against the
  latest Ubuntu base image.

<!-- https://spectrocloud.atlassian.net/browse/PEM-10677 -->

- Fixed security vulnerabilities (CVE-2026-40224, CVE-2026-28390) in the MongoDB Enterprise image by rebuilding it
  against the latest Ubuntu base image.

<!-- https://spectrocloud.atlassian.net/browse/PCP-6560 -->

- Fixed an issue where pods experienced image pull back-off errors when upgrading from PXK 1.32.13 to 1.33.10 in
  connected Azure environments.
