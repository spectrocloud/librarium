...
<RedirectPackPage packName="k8s-dashboard" />
...
To learn more about it and start using it, check out the <VersionedLink text="Spectro Kubernetes Dashboard" url="/clusters/cluster-management/spectro-kubernetes-dashboard" /> guide.
