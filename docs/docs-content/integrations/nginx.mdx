...
<RedirectPackPage packName="nginx" />

:::warning

The Nginx pack is now deprecated. We recommend using an alternative ingress controller, such as <VersionedLink text="Kgateway" url="/integrations/packs/?pack=kgateway" /> or <VersionedLink text="Traefik" url="/integrations/packs/?pack=traefik" />. Refer to the [Ingress NGINX Retirement: What You Need to Know](https://www.kubernetes.dev/blog/2025/11/12/ingress-nginx-retirement/) blog for further information.
