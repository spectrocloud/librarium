...
Beginning with 0.17.0, the External Secrets Operator pack no longer supports `apiVersion: v1beta1`.  Manifests related to this pack that specify `apiVersion: v1beta1` cannot be used to create or update Kubernetes objects after upgrading the pack to version 0.17.0 or later. Update your manifests to use `apiVersion: v1` to successfully create objects after upgrading your pack version.
