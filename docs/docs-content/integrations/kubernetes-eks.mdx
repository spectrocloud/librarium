...
This section only applies to worker node pools where you have selected to use a custom
[Amazon Machine Image (AMI) Type](../clusters/public-cloud/aws/eks.md#cloud-configuration-settings), such as Amazon
...
manifest in the top-level of the YAML file. Ensure it is not nested under any other section.

:::

### Configure Amazon Linux 2 AMI Nodes

If you have selected an Amazon Linux 2 AMI for one or more of your worker node groups, you can provide additional
...
If you have selected an Amazon Linux 2023 AMI for one or more of your worker node groups, you can provide additional
configuration as described in the following table.

| Parameter                                         | Type                   | Description                                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------------------- | ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `userdataScript`                                  | String (block scalar)  | A custom multi-line Bash script that is executed on every worker node after `nodeadm` finishes. You can use it to install agents, pre-pull images, or run any extra bootstrap logic.                                                                                                                                                                       |
