...
The _lb-metallb_ manifest-based pack supports direct configuration of an L2 IP address set. The _lb-metallb-helm_ Helm-based pack provides an L2 address pool.
