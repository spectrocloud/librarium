...
Spectro Cloud verified packs are scanned for known Common Vulnerabilities and Exposures (CVEs) as part of our build and validation process. To learn more about how Spectro Cloud handles CVEs, check out the [Pack CVE Handling Policy](./cve-policy.md) reference.
