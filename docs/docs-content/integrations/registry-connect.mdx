...
Modify your pack to rewrite container image references to an external registry.
...
Use the `imageReplacementRules` parameter to rewrite image references by replacing specific source registry prefixes with an external registry.
