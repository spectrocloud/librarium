...
You can learn how to add the Spectro Kubernetes Dashboard pack to your cluster by following the steps outline in the [Spectro Kubernetes Dashboard](../clusters/cluster-management/kubernetes-dashboard/) page. 
