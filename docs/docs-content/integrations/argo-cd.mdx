...
For successful restores on Edge Native clusters configured with Longhorn, set a numeric non-root user and group ID in the Argo CD pack `values.yaml` file under `global.securityContext`.
