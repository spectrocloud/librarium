...
| `charts.cluster-autoscaler.autoDiscovery.clusterName` | The parameter that enables autodiscovery within the EKS host cluster.                                                                                                                                                                                                                                       | `{{ .spectro.system.cluster.name }}` | Yes          |
