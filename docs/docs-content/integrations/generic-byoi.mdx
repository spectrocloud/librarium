...
addition to Ubuntu. Configure the following BYOOS pack fields for MAAS:
...
| `osName`           | The OS name that MAAS uses to identify the image. Examples include `rhel`, `rocky`, and `sles`.                                                                                        |
| `osVersion`        | The OS version. Examples include `9.4` and `8`.                                                                                                                                        |
