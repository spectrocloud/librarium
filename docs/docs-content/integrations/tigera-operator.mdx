...
Tigera Operator is a Kubernetes operator that deploys and manages the complete Calico or Calico Enterprise stack on Kubernetes and OpenShift clusters. It automates lifecycle operations including installation, upgrades, configuration, and health monitoring.
