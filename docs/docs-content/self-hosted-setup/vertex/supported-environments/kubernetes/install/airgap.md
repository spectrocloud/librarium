...
title: "Install Airgap Palette VerteX on Kubernetes"
description:
...
SaaS. Review our [architecture diagrams](../../../../../architecture/networking-ports.md) to ensure your Kubernetes
cluster has the necessary network connectivity for VerteX to operate successfully.
