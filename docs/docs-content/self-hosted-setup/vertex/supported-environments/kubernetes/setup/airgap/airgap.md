...
description:
  "Set up your airgap environment in preparation to install self-hosted Palette VerteX on an existing Kubernetes
  cluster."
icon: ""
...
13. Review the additional packs available for download. The supplemental packs are optional and not required for a
    ...
    download. Refer to the [Additional Packs](../../../../../../downloads/palette-vertex/additional-packs.md) resource
