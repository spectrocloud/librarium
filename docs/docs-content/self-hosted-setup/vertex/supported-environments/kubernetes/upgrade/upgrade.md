...
title: "Upgrade Palette VerteX on Kubernetes"
description: "Upgrade self-hosted Palette VerteX installed on a Kubernetes cluster."
icon: ""
hide_table_of_contents: false
tags: ["self-hosted", "vertex", "helm", "kubernetes", "upgrade"]
keywords: ["self-hosted", "vertex", "helm", "kubernetes", "upgrade"]
---

:::danger

The below content is from the former [VerteX Upgrade](https://docs.spectrocloud.com/vertex/upgrade/) page. Convert to
partials and refactor where necessary. Only mention Kubernetes!
...
If you are using self-hosted Palette instead of Palette VerteX, refer to the
[Palette Upgrade](../../../../palette/supported-environments/kubernetes/upgrade/upgrade.md) page for upgrade guidance.
...
Refer to the following tables for the supported upgrade paths for self-hosted Palette VerteX environments installed on a
...
between Palette versions. Ensure that you have addressed all changes before upgrading Palette VerteX.
...
|       4.8.9        |       4.8.33       | :white_check_mark: |
|       4.8.9        |       4.8.25       | :white_check_mark: |
...
|       4.7.29       |       4.8.25       | :white_check_mark: |
...
|       4.7.29       |       4.8.33       | :white_check_mark: |
|       4.7.29       |       4.8.25       | :white_check_mark: |
|       4.7.29       |       4.8.23       | :white_check_mark: |
|       4.7.29       |       4.8.21       | :white_check_mark: |
|       4.7.29       |       4.8.12       | :white_check_mark: |
|       4.7.29       |       4.8.8        | :white_check_mark: |
|       4.7.27       |       4.8.37       | :white_check_mark: |
