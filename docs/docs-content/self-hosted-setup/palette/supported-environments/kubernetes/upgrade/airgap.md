...
- Access to the latest Palette airgap setup binary. Refer to [Access Palette](../../../palette.md#access-palette) for
  more details.
...
- Access to the latest Palette Helm Chart. Refer to [Access Palette](../../../palette.md#access-palette) for more
  details.
...
7.  Refer to the [Additional Packs](../../../../../downloads/self-hosted-palette/additional-packs.md) page and update
    the packages you are currently using. You must update each package separately.
