...
title: "Install Non-Airgap Palette on VMware vSphere with Palette CLI"
...
4.  Append an `r_` prefix to the OVA name and remove the `.ova` suffix after the import. For example, the final output
    ...
    OVA. Refer to the [Additional OVAs](../../../../../downloads/self-hosted-palette/additional-ovas.md) page for a list
    of additional OVAs you can download and upload to your vCenter environment.
