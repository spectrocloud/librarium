...
The Palette SaaS platform can manage clusters on public clouds (AWS, Azure, and Google Cloud), data centers (VMware vSphere, Apache
CloudStack, MAAS, and Nutanix), and bare metal devices. The architecture and data flow slightly differ based on whether
the target environment is a public cloud or private data center.
