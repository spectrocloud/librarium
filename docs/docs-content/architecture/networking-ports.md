...
![SaaS Network Diagram with ports without a PCG](/architecture_networking-ports_saas-network-diagram-grpc-no-pcg_4-8.webp)

### SaaS Managed With a PCG

![SaaS Network Diagram with ports using a PCG](/architecture_networking-ports_saas-network-diagram-grpc_4-8.webp "title=SaaS Network Diagram with ports w/PCG")

### SaaS Managed With Edge

![SaaS network diagram displaying the network paths for edge](/architecture_networking-ports_saas-network-diagram-edge-grpc_4-8.webp)
...
![On-prem network diagram](/architecture_networking-ports_on_prem_network-diagram-grpc-new_4-8.webp)
