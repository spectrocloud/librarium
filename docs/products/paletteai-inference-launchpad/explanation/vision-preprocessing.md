...
Spectro Cloud has validated this pairing with GLM 5.2 as the text model and Qwen 3.5 9B as the vision model on 8 x B200
hardware. Other pairings can work when both models fit on the node. For the certified text models, refer to
