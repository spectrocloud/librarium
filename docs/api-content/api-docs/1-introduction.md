...
endpoints are not available to connected Edge hosts and are available to disconnected Edge hosts only. The following is
a list of endpoints that are only available to disconnected Edge hosts:
