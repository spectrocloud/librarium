...
- An Authentication header with a token value or an API key. Learn more about authentication credentials by reviewing the [authentication methods](/user-management/authentication/api-key) resource.
