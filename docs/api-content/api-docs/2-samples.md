...
- An Authentication header with a token value or an API Key with an ApiKey value. Learn more about authentication
  credentials by reviewing the
  [authentication methods](https://docs.spectrocloud.com/user-management/user-authentication) resource.
