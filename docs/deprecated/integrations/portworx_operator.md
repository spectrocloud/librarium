...
[Flash Array license JSON](https://docs.portworx.com/portworx-enterprise/platform/kubernetes/flasharray/install/install-flasharray-on-cloud#create-a-json-configuration-file).
