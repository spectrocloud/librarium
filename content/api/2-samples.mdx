...
Check out the [Palette Postman collection](api/v1/overview#postman-collection) resource to learn more about the Postman collection.
...
<Tabs.TabPane tab="Python" key="cluster-create-python">
...
<Tabs.TabPane tab="curl" key="cluster-create-status-curl">
...
<Tabs.TabPane tab="JavaScript" key="cluster-create-status-js">
...
<Tabs.TabPane tab="Go" key="cluster-create-status-go">
...
<Tabs.TabPane tab="Python" key="cluster-create-status-python">
...
<Tabs.TabPane tab="Rust" key="cluster-create-status-rust">
...
<Tabs.TabPane tab="curl" key="cluster-workloads-curl">
...
<Tabs.TabPane tab="JavaScript" key="cluster-workloads-js">
...
<Tabs.TabPane tab="Go" key="cluster-workloads-go">
...
<Tabs.TabPane tab="Python" key="cluster-workloads-python">
...
<Tabs.TabPane tab="Rust" key="cluster-workloads-rust">
...
<Tabs.TabPane tab="curl" key="cluster-search-curl">
...
<Tabs.TabPane tab="JavaScript" key="cluster-search-js">
...
<Tabs.TabPane tab="Go" key="cluster-search-go">
...
<Tabs.TabPane tab="Python" key="cluster-search-python">
...
<Tabs.TabPane tab="Rust" key="cluster-search-rust">
...
<Tabs.TabPane tab="cURL" key="cluster-kubeconfig-curl">
...
<Tabs.TabPane tab="JavaScript" key="cluster-kubeconfig-js">
...
<Tabs.TabPane tab="Go" key="cluster-kubeconfig-go">
...
<Tabs.TabPane tab="Python" key="cluster-kubeconfig-python">
...
<Tabs.TabPane tab="Rust" key="cluster-kubeconfig-rust">
