...
Registry and Palette Artifact Repository(PAR) are required parameters in the **values.yaml** for installing Palette using Helm Chart.
...
Please contact the Spectro Cloud support team at [support@spectrocloud.com](support@spectrocloud.com) to receive the required values and credentials for PAR.
