...
<Tabs>
<Tabs.TabPane tab="Use Internal KVDB Preset" key="Use Internal KVDB">
...
<Tabs.TabPane tab="Use Non-Secure KVDB Endpoints" key="Use Non-Secure KVDB Endpoints">
...
<Tabs.TabPane tab="Use Certs Secured KVDB Endpoints" key="Use Certs Secured KVDB Endpoints">
