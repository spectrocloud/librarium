...
Palette users can launch Azure clusters without a PCG also. Self-hosted PCG is a security enhancement feature from Palette. To enjoy the additional benefits of this private cloud Self-hosted PCG, users need to [attach them to the Palette Azure cloud account](/gateways#attachtheselfhostedpcgtotheazurecloudaccount).
