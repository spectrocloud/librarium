...
1. Download the CLI binary file:
    ...
    ```bash
    wget https://spectro-cli.s3.amazonaws.com/v3.2.0/osx/spectro
    ```
    ...
    ```bash
    wget https://spectro-cli.s3.amazonaws.com/v3.2.0/linux/spectro
    ```
...
```bash
 spectro  version
Spectro ClI Version 3.2.0 linux/amd64
```
