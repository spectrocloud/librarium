...
Use the following command to download the `ghcr.io/spectrocloud/tutorials:1.0.3` image to your local machine. The Docker image includes the necessary tools. 
<br />
