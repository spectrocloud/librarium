...
| cloudTypes | Array | True | Supported values are as follows. You can provide one or more types for a pack: <br /><br />**all**, **aws**, **azure**, **gcp**, **tencent**, **vsphere**, **openstack**, **baremetal**, **maas**, **aks**, **eks**, , **tke**, **edge** (Edge), **edge-native** (Edge 2.0), and **libvirt** (Virtual Edge and virtual clusters).
