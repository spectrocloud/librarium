...
After deleting the cluster and the cluster profile, stop the registry server by closing the tutorials container bash session serving the Ngrok reverse proxy server. At this point, you can delete all bash sessions into the tutorials container. 
