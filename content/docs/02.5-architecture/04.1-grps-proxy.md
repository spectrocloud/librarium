...
When you review the vendor documentation, search for information about gRPC and HTTP/2. We have provided links to some of the vendors' documentation that addresses the HTTP2 and gRPC support.
