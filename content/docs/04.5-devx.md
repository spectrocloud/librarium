...
* To enable it again toggle the button again and select the social sign in platform the developers wants to use. We currently support Google and Git Hub based Sign In.
