...
Observability (O11y) of Kubernetes clusters and their metrics is an important operational capability. Palette offers a pack for collecting metrics from host clusters which can then be scraped by a monitoring stack.
