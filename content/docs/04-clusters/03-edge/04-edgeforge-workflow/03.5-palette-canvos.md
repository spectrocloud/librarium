...
5. This step is also optional. In this step, you can modify the existing Dockerfile to suit your needs. For example, here is a sample Dockerfile to install [WireGuard](https://www.wireguard.com/install/) on the Edge host. 
  <br />
