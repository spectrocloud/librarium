...
You must have a tenant registration token before starting either of the workflows below. The Advanced workflow will also require a [Docker Hub](https://hub.docker.com/) account. If you do not have one already, refer to the [Create an account](https://docs.docker.com/docker-id/) page for signing-up instructions.
