...
# Overview
Palette's Edge solution requires Edge hosts to be ready with the required software and configurations before deploying a host cluster comprising Edge hosts. An Edge hosts 
 required the following artifacts for a successful deployment:
<br />
...
* **Provider OS image** - This is a [Kairos](https://kairos.io/)-based image. You can use this image to install an immutable Operating System (OS) and software dependencies compatible with a specific Kubernetes version at runtime, i.e., during the cluster deployment.  
<br />
...
You can follow either of the below workflows - Basic or Advanced. Use Basic for a quick start so that you can get all the required artifacts for creating an Edge host cluster profile.  Use the Advanced section for detailed instructions and to learn about customization options you can apply to this workflow. 
<br />
