...
6. Complete the **Cluster config** section with the information for each parameter listed below.
    ...
    | **Placement**      | You may leave this unchecked, unless the choice of placement is Static:<br /> <br /> **Resource Group for Virtual Network**: Select the resource group in which your virtual network is present from the dropdown menu. <br /><br /> **Virtual Network**: Select the virtual network from the virtual network dropdown menu. <br /> <br /> **CIDR Block**: Choose the CIDR block for the VNet in the group of addresses. <br /> <br /> **Control plane Subnet**: Select the control plane network from the dropdown menu.
