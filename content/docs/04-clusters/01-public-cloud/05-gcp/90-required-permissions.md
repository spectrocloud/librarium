...
| iam.serviceAccounts.get                  | Get service account information                               |
...
| storage.objects.get                      | Get object information in Cloud Storage                       |
| storage.objects.list                     | List objects in Cloud Storage                                 |
