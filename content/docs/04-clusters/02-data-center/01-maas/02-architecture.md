...
- Palette integrates with MAAS through Spectro Cloud’s open source Cloud Native Computing Foundation (CNCF) [Cluster API](https://github.com/spectrocloud/cluster-api-provider-maas).
