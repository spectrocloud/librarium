...
At a very high level, the following will occur during a successful MAAS PCG installation:
- use a PCG installer docker image that you will run on a laptop, workstation, or jump box
