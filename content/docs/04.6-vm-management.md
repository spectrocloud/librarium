...
- Organizations that want to remove their virtualization infrastructure due to an aging environment or to reduce costs. Using Palette VM Management, legacy applications and modern, containerized applications can be deployed on virtual machines. 
...
Palette VM Management does not support Edge native environments or K3s.
