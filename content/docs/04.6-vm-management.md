...
To start with VM Management, review Packs and Profiles to learn about components of the Spectro VM Dashboard integrated pack. Next, become familiar with the Spectro VM Dashboard and review how to Enable the Dashboard. The dashboard provides various methods to quickly deploy VMs from out-of-the-box templates or from your organization's templates. Review Deploy VM From a Template and Create a VM Template.
...
- [Create and Manage VMs](/vm-management/create-manage-vm/standard-vm-operations/deploy-vm-from-template)
