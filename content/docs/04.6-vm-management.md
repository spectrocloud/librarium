...
To gain access to the VM Management solution, please contact our support team by sending an email to support@spectrocloud.com. With this license, you will receive credentials and an endpoint URL to access the registry that stores the Spectro VM Dashboard pack. 
