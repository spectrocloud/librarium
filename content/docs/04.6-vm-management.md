...
<!-- Next, become familiar with features of the [Spectro VM Dashboard](/vm-management/vm-packs-profiles/vm-dashboard) and the web interface it provides to manage your VMs.  -->

Review [Create a VMO Profile](/vm-management/vm-packs-profiles/create-vmo-profile) and [Add Roles and Role Bindings](/vm-management/vm-packs-profiles/enable-vm-dashboard) to learn how to create the cluster profile and add roles and permissions that allow users to create and manage Virtual Machines (VMs). 
