...
KubeVirt offers certain features that require explicit enabling through the use of Kubernetes [Feature Gates](https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/). These gates are a set of key-value pairs that allow the toggling of specific features.
...
Palette's VM Management automatically enables the following feature gates by default:
