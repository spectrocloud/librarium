...
The Spectro Cloud Cryptographic Module is a general-purpose cryptographic library. Our FIPS-enforced Palette VerteX edition incorporates the module in the Kubernetes Management Platform and the infrastructure components of target clusters to protect the sensitive information of regulated industries, such as government and public sector organizations that handle sensitive and classified information. To learn more, check out [Palette VerteX](/vertex). VerteX supports FIPS at the tenant level.
