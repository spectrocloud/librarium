...
* Palette provides [out-of-the-box](/devx/app-profile#messagingsystemservices) support for application services such as Kafka, MySQL, NATS, etc., for Palette Dev Engine. These services can be specified when creating an App Profile.
