...
- **Create a Client button casing corrected.** Live UI reads **Add Client** (title case). Tutorial line 209 was **Add client** (sentence case) in two places (the button and the wizard title). Both updated to title case. Applied.
